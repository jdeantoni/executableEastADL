/**
 */
package fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.util;
 ...
 * <!-- end-user-doc -->
 * @see fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage
 * @generated
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InterchangePackage.RIF_AREA: {
				...
				if (result == null) result = caseEAPackageableElement(rifArea);
				if (result == null) result = caseEAElement(rifArea);
				if (result == null) result = caseGEAPackageableElement(rifArea);
				if (result == null) result = caseIdentifiable(rifArea);
				if (result == null) result = caseReferrable(rifArea);
				if (result == null) result = caseGIdentifiable(rifArea);
				if (result == null) result = caseGReferrable(rifArea);
			...
			case InterchangePackage.RIF_EXPORT_AREA: {
				...
				if (result == null) result = caseEAPackageableElement(rifExportArea);
				if (result == null) result = caseEAElement(rifExportArea);
				if (result == null) result = caseGEAPackageableElement(rifExportArea);
				if (result == null) result = caseIdentifiable(rifExportArea);
				if (result == null) result = caseReferrable(rifExportArea);
				if (result == null) result = caseGIdentifiable(rifExportArea);
				if (result == null) result = caseGReferrable(rifExportArea);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InterchangePackage.RIF_IMPORT_AREA: {
				...
				if (result == null) result = caseEAPackageableElement(rifImportArea);
				if (result == null) result = caseEAElement(rifImportArea);
				if (result == null) result = caseGEAPackageableElement(rifImportArea);
				if (result == null) result = caseIdentifiable(rifImportArea);
				if (result == null) result = caseReferrable(rifImportArea);
				if (result == null) result = caseGIdentifiable(rifImportArea);
				if (result == null) result = caseGReferrable(rifImportArea);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
