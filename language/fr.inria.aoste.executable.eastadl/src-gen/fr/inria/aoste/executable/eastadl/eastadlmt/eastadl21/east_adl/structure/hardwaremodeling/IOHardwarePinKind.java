 ...
 * <!-- end-user-doc -->
 * @see fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage#getIOHardwarePinKind()
 * @model
 * @generated
 */
public enum IOHardwarePinKind implements Enumerator {
	 ...
	 *        annotation="TaggedValues xml.name='DIGITAL' xml.namePlural='DIGITALS' xml.nsPrefix='EA' xml.nsUri='http://east-adl.info/2.1.10'"
	 * @generated
	 * @ordered
	 */
	 ...
	 *        annotation="TaggedValues xml.name='ANALOG' xml.namePlural='ANALOGS' xml.nsPrefix='EA' xml.nsUri='http://east-adl.info/2.1.10'"
	 * @generated
	 * @ordered
	 */
	 ...
	 *        annotation="TaggedValues xml.name='PWM' xml.namePlural='PWMS' xml.nsPrefix='EA' xml.nsUri='http://east-adl.info/2.1.10'"
	 * @generated
	 * @ordered
	 */
