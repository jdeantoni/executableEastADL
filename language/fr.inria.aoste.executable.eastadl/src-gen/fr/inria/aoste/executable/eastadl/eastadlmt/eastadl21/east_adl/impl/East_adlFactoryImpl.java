...
import fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.*;
...
public class East_adlFactoryImpl extends EFactoryImpl implements East_adlFactory {
	...
	public static East_adlFactory init() {
		try {
			East_adlFactory theEast_adlFactory = (East_adlFactory)EPackage.Registry.INSTANCE.getEFactory(East_adlPackage.eNS_URI);
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case East_adlPackage.TRICK_EMF:
