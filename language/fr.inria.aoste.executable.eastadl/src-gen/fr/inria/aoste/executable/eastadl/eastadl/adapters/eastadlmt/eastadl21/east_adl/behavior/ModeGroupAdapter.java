...
public class ModeGroupAdapter extends EObjectAdapter<ModeGroup> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.ModeGroup {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public ModeGroupAdapter() {
  ...
  public String getPrecondition() {
    return adaptee.getPrecondition();
  }
  
  @Override
  public void setPrecondition(final String o) {
    adaptee.setPrecondition(o);
  }
  
  @Override
  public void unsetPrecondition() {
    adaptee.unsetPrecondition() ;
  }
  
  @Override
  public boolean isSetPrecondition() {
    return adaptee.isSetPrecondition() ;
  }
  ...
  protected final static String PRECONDITION_EDEFAULT = "";
  
  @Override
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.eINSTANCE.getModeGroup();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__GEA_PACKAGE_ELEMENT:
    		return getGEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__EA_PACKAGE_ELEMENT:
    		return getEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__TEXT:
    		return getText();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__PRECONDITION:
    		return getPrecondition();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.MODE_GROUP__MODE:
    		return getMode();
    }
