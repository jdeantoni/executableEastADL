...
public class RIFExportAreaAdapter extends EObjectAdapter<RIFExportArea> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.RIFExportArea {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public RIFExportAreaAdapter() {
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.eINSTANCE.getRIFExportArea();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__GEA_PACKAGE_ELEMENT:
    		return getGEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__EA_PACKAGE_ELEMENT:
    		return getEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__TRACEABLE_SPECIFICATION:
    		return getTraceableSpecification();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__OWNED_RELATIONSHIP:
    		return getOwnedRelationship();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__INTERCHANGE_REQ_SPEC_OBJECT:
    		return getInterchangeReqSpecObject();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__ROOT_REQUIREMENT_CONTAINER:
    		return getRootRequirementContainer();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.InterchangePackage.RIF_EXPORT_AREA__USER_DEFINED_TYPE:
