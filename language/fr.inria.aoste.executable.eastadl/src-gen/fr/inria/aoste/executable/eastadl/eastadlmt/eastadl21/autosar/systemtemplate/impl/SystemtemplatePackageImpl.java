/**
 */
package fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.autosar.systemtemplate.impl;
 ...
 * @generated
 */
public class SystemtemplatePackageImpl extends EPackageImpl implements SystemtemplatePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.autosar.systemtemplate.SystemtemplatePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SystemtemplatePackageImpl() {
		super(eNS_URI, SystemtemplateFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link SystemtemplatePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SystemtemplatePackage init() {
		if (isInited) return (SystemtemplatePackage)EPackage.Registry.INSTANCE.getEPackage(SystemtemplatePackage.eNS_URI);

		// Obtain or create and register package
		SystemtemplatePackageImpl theSystemtemplatePackage = (SystemtemplatePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SystemtemplatePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SystemtemplatePackageImpl());
		...
		theSystemtemplatePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SystemtemplatePackage.eNS_URI, theSystemtemplatePackage);
		return theSystemtemplatePackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSystem_EcuExtractVersion() {
	 ...
	 * @generated
	 */
	public EAttribute getSystem_SystemVersion() {
	...
	public SystemtemplateFactory getSystemtemplateFactory() {
		return (SystemtemplateFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(systemEClass, SYSTEM__ECU_EXTRACT_VERSION);
		createEAttribute(systemEClass, SYSTEM__SYSTEM_VERSION);
	}
	...
	public void initializePackageContents() {
		...
		AutosartoplevelstructurePackage theAutosartoplevelstructurePackage = (AutosartoplevelstructurePackage)EPackage.Registry.INSTANCE.getEPackage(AutosartoplevelstructurePackage.eNS_URI);
		...
		systemEClass.getESuperTypes().add(theAbstractstructurePackage.getAtpStructureElement());
		systemEClass.getESuperTypes().add(theAutosartoplevelstructurePackage.getARElement());

		// Initialize classes and features; add operations and parameters
		initEClass(systemEClass, fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.autosar.systemtemplate.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSystem_EcuExtractVersion(), thePrimitivetypesPackage.getRevisionLabelString(), "ecuExtractVersion", "", 0, 1, fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.autosar.systemtemplate.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_SystemVersion(), thePrimitivetypesPackage.getRevisionLabelString(), "systemVersion", "", 1, 1, fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.autosar.systemtemplate.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}

} //SystemtemplatePackageImpl
