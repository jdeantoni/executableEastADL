...
public class NodeAdapter extends EObjectAdapter<Node> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.Node {
  ...
  public Integer getNonVolatileMemory() {
    return adaptee.getNonVolatileMemory();
  }
  
  @Override
  public void setNonVolatileMemory(final Integer o) {
    adaptee.setNonVolatileMemory(o);
  }
  
  @Override
  public void unsetNonVolatileMemory() {
    adaptee.unsetNonVolatileMemory() ;
  }
  
  @Override
  public boolean isSetNonVolatileMemory() {
    return adaptee.isSetNonVolatileMemory() ;
  }
  
  @Override
  public Double getExecutionRate() {
    return adaptee.getExecutionRate();
  }
  
  @Override
  public void setExecutionRate(final Double o) {
    adaptee.setExecutionRate(o);
  }
  
  @Override
  public void unsetExecutionRate() {
    adaptee.unsetExecutionRate() ;
  }
  
  @Override
  public boolean isSetExecutionRate() {
    return adaptee.isSetExecutionRate() ;
  }
  
  @Override
  public Integer getVolatileMemory() {
    return adaptee.getVolatileMemory();
  }
  
  @Override
  public void setVolatileMemory(final Integer o) {
    adaptee.setVolatileMemory(o);
  }
  
  @Override
  public void unsetVolatileMemory() {
    adaptee.unsetVolatileMemory() ;
  }
  
  @Override
  public boolean isSetVolatileMemory() {
    return adaptee.isSetVolatileMemory() ;
  }
  ...
  protected final static Integer NON_VOLATILE_MEMORY_EDEFAULT = new Integer(0);
  
  protected final static Double EXECUTION_RATE_EDEFAULT = new Double(0.0);
  
  protected final static Integer VOLATILE_MEMORY_EDEFAULT = new Integer(0);
  
  @Override
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.eINSTANCE.getNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__GEA_PACKAGE_ELEMENT:
    		return getGEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__EA_PACKAGE_ELEMENT:
    		return getEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__TRACEABLE_SPECIFICATION:
    		return getTraceableSpecification();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__OWNED_RELATIONSHIP:
    		return getOwnedRelationship();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__CONNECTOR:
    		return getConnector();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__PORT:
    		return getPort();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__PART:
    		return getPart();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__PORT_GROUP:
    		return getPortGroup();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__BUS:
    		return getBus();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__NON_VOLATILE_MEMORY:
    		return getNonVolatileMemory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__EXECUTION_RATE:
    		return getExecutionRate();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.structure.hardwaremodeling.HardwaremodelingPackage.NODE__VOLATILE_MEMORY:
