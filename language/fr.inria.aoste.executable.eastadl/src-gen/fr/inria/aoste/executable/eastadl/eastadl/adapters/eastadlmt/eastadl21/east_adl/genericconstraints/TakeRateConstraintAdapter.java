...
public class TakeRateConstraintAdapter extends EObjectAdapter<TakeRateConstraint> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.TakeRateConstraint {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public TakeRateConstraintAdapter() {
  ...
  public Double getTakeRate() {
    return adaptee.getTakeRate();
  }
  
  @Override
  public void setTakeRate(final Double o) {
    adaptee.setTakeRate(o);
  }
  
  @Override
  public void unsetTakeRate() {
    adaptee.unsetTakeRate() ;
  }
  
  @Override
  public boolean isSetTakeRate() {
    return adaptee.isSetTakeRate() ;
  }
  ...
  protected final static Double TAKE_RATE_EDEFAULT = new Double(0.0);
  
  @Override
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.eINSTANCE.getTakeRateConstraint();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__GEA_PACKAGE_ELEMENT:
    		return getGEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__EA_PACKAGE_ELEMENT:
    		return getEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__TEXT:
    		return getText();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__GENERIC_CONSTRAINT_TYPE:
    		return getGenericConstraintType();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__GENERIC_CONSTRAINT_VALUE:
    		return getGenericConstraintValue();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__TARGET:
    		return getTarget();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__MODE:
    		return getMode();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__TAKE_RATE:
    		return getTakeRate();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage.TAKE_RATE_CONSTRAINT__SOURCE:
    		return getSource();
    }
