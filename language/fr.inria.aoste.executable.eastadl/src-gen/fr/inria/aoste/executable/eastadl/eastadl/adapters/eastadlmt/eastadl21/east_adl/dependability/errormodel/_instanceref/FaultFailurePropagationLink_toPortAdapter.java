...
public class FaultFailurePropagationLink_toPortAdapter extends EObjectAdapter<FaultFailurePropagationLink_toPort> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.errormodel._instanceref.FaultFailurePropagationLink_toPort {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public FaultFailurePropagationLink_toPortAdapter() {
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.errormodel._instanceref._instancerefPackage.eINSTANCE.getFaultFailurePropagationLink_toPort();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.errormodel._instanceref._instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_TO_PORT__FAULT_FAILURE_PORT:
    		return getFaultFailurePort();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.errormodel._instanceref._instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_TO_PORT__ERROR_MODEL_PROTOTYPE:
    		return getErrorModelPrototype();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.errormodel._instanceref._instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_TO_PORT__FAULT_FAILURE_PORT_PROXY:
