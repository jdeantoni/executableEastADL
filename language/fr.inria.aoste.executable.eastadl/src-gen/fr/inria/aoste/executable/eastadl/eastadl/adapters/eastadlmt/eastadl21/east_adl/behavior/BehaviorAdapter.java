...
public class BehaviorAdapter extends EObjectAdapter<Behavior> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.Behavior {
  ...
  private EList<ModeGroup> modeGroup_;
  
  @Override
  public EList<ModeGroup> getModeGroup() {
    if (modeGroup_ == null)
    	modeGroup_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getModeGroup(), adaptersFactory, eResource);
    return modeGroup_;
  }
  
  private EList<FunctionBehavior> behavior_;
  
  @Override
  public EList<FunctionBehavior> getBehavior() {
    if (behavior_ == null)
    	behavior_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getBehavior(), adaptersFactory, eResource);
    return behavior_;
  }
  
  private EList<FunctionTrigger> functionTrigger_;
  
  @Override
  public EList<FunctionTrigger> getFunctionTrigger() {
    if (functionTrigger_ == null)
    	functionTrigger_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getFunctionTrigger(), adaptersFactory, eResource);
    return functionTrigger_;
  }
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.eINSTANCE.getBehavior();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__GEA_PACKAGE_ELEMENT:
    		return getGEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__EA_PACKAGE_ELEMENT:
    		return getEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__TRACEABLE_SPECIFICATION:
    		return getTraceableSpecification();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__OWNED_RELATIONSHIP:
    		return getOwnedRelationship();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__MODE_GROUP:
    		return getModeGroup();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__BEHAVIOR:
    		return getBehavior();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__FUNCTION_TRIGGER:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__MODE_GROUP:
    		return getModeGroup() != null && !getModeGroup().isEmpty();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__BEHAVIOR:
    		return getBehavior() != null && !getBehavior().isEmpty();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__FUNCTION_TRIGGER:
    		return getFunctionTrigger() != null && !getFunctionTrigger().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__MODE_GROUP:
    		getModeGroup().clear();
    		getModeGroup().addAll((Collection) newValue);
    		return;
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__BEHAVIOR:
    		getBehavior().clear();
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.behavior.BehaviorPackage.BEHAVIOR__FUNCTION_TRIGGER:
    		...
    		getFunctionTrigger().addAll((Collection) newValue);
    		return;
    }
