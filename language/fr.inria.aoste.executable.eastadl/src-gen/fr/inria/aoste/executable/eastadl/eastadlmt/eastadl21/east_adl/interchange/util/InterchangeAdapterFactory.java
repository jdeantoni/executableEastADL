...
public class InterchangeAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.RIFArea <em>RIF Area</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.RIFExportArea <em>RIF Export Area</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.interchange.RIFImportArea <em>RIF Import Area</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
