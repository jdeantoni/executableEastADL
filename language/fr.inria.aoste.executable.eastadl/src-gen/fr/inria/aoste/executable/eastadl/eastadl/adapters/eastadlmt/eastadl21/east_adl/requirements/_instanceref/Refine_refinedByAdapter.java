...
public class Refine_refinedByAdapter extends EObjectAdapter<Refine_refinedBy> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.requirements._instanceref.Refine_refinedBy {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public Refine_refinedByAdapter() {
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.requirements._instanceref._instancerefPackage.eINSTANCE.getRefine_refinedBy();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.requirements._instanceref._instancerefPackage.REFINE_REFINED_BY__IDENTIFIABLE_CONTEXT:
    		return getIdentifiable_context();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.requirements._instanceref._instancerefPackage.REFINE_REFINED_BY__IDENTIFIABLE_TARGET:
