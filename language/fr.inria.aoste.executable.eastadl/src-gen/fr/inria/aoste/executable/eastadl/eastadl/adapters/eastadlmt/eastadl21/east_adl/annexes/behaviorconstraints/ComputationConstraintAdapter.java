...
public class ComputationConstraintAdapter extends EObjectAdapter<ComputationConstraint> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.ComputationConstraint {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public ComputationConstraintAdapter() {
  ...
  private EList<Flow> flow_;
  
  @Override
  public EList<Flow> getFlow() {
    if (flow_ == null)
    	flow_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getFlow(), adaptersFactory, eResource);
    return flow_;
  }
  
  private EList<Transformation> transformation_;
  
  @Override
  public EList<Transformation> getTransformation() {
    if (transformation_ == null)
    	transformation_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getTransformation(), adaptersFactory, eResource);
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.eINSTANCE.getComputationConstraint();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__CONSTRAINED_MODE:
    		return getConstrainedMode();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__RELATED_VEHICLE_FEATURE:
    		return getRelatedVehicleFeature();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__CONSTRAINED_FUNCTION_BEHAVIOR:
    		return getConstrainedFunctionBehavior();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__CONSTRAINED_ERROR_BEHAVIOR:
    		return getConstrainedErrorBehavior();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__CONSTRAINED_FUNCTION_TRIGGER:
    		return getConstrainedFunctionTrigger();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__FLOW:
    		return getFlow();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__TRANSFORMATION:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__TRANSFORMATION:
    		return getTransformation() != null && !getTransformation().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.COMPUTATION_CONSTRAINT__TRANSFORMATION:
    		...
    		getTransformation().addAll((Collection) newValue);
    		return;
    }
