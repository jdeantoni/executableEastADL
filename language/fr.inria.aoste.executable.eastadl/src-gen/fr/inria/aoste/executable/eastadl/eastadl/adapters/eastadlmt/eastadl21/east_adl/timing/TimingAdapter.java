...
public class TimingAdapter extends EObjectAdapter<Timing> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.Timing {
  ...
  private EList<TimingDescription> timingDescription_;
  
  @Override
  public EList<TimingDescription> getTimingDescription() {
    if (timingDescription_ == null)
    	timingDescription_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getTimingDescription(), adaptersFactory, eResource);
    return timingDescription_;
  }
  
  private EList<TimingConstraint> timingConstraint_;
  
  @Override
  public EList<TimingConstraint> getTimingConstraint() {
    if (timingConstraint_ == null)
    	timingConstraint_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getTimingConstraint(), adaptersFactory, eResource);
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.eINSTANCE.getTiming();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__GEA_PACKAGE_ELEMENT:
    		return getGEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__EA_PACKAGE_ELEMENT:
    		return getEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__TRACEABLE_SPECIFICATION:
    		return getTraceableSpecification();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__OWNED_RELATIONSHIP:
    		return getOwnedRelationship();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__TIMING_DESCRIPTION:
    		return getTimingDescription();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__TIMING_CONSTRAINT:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__TIMING_DESCRIPTION:
    		return getTimingDescription() != null && !getTimingDescription().isEmpty();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__TIMING_CONSTRAINT:
    		return getTimingConstraint() != null && !getTimingConstraint().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__TIMING_DESCRIPTION:
    		...
    		getTimingDescription().addAll((Collection) newValue);
    		return;
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing.TimingPackage.TIMING__TIMING_CONSTRAINT:
