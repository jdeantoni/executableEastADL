...
public class PrecedenceConstraint_successiveAdapter extends EObjectAdapter<PrecedenceConstraint_successive> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing._instanceref.PrecedenceConstraint_successive {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public PrecedenceConstraint_successiveAdapter() {
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing._instanceref._instancerefPackage.eINSTANCE.getPrecedenceConstraint_successive();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing._instanceref._instancerefPackage.PRECEDENCE_CONSTRAINT_SUCCESSIVE__FUNCTION_PROTOTYPE_CONTEXT:
    		return getFunctionPrototype_context();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.timing._instanceref._instancerefPackage.PRECEDENCE_CONSTRAINT_SUCCESSIVE__FUNCTION_PROTOTYPE_TARGET:
