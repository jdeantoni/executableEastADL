...
public class FunctionalSafetyConceptAdapter extends EObjectAdapter<FunctionalSafetyConcept> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.FunctionalSafetyConcept {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public FunctionalSafetyConceptAdapter() {
  ...
  private EList<Requirement> functionalSafetyRequirement_;
  
  @Override
  public EList<Requirement> getFunctionalSafetyRequirement() {
    if (functionalSafetyRequirement_ == null)
    	functionalSafetyRequirement_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getFunctionalSafetyRequirement(), adaptersFactory, eResource);
    return functionalSafetyRequirement_;
  }
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.eINSTANCE.getFunctionalSafetyConcept();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__GEA_PACKAGE_ELEMENT:
    		return getGEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__EA_PACKAGE_ELEMENT:
    		return getEAPackage_element();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__TEXT:
    		return getText();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__CONTAINED_REQ_SPEC_OBJECT:
    		return getContainedReqSpecObject();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__CHILD_CONTAINER:
    		return getChildContainer();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__FUNCTIONAL_SAFETY_REQUIREMENT:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__FUNCTIONAL_SAFETY_REQUIREMENT:
    		return getFunctionalSafetyRequirement() != null && !getFunctionalSafetyRequirement().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.dependability.safetyrequirement.SafetyrequirementPackage.FUNCTIONAL_SAFETY_CONCEPT__FUNCTIONAL_SAFETY_REQUIREMENT:
    		...
    		getFunctionalSafetyRequirement().addAll((Collection) newValue);
    		return;
    }
