...
public class StateMachineConstraintAdapter extends EObjectAdapter<StateMachineConstraint> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.StateMachineConstraint {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public StateMachineConstraintAdapter() {
  ...
  private EList<State> state_;
  
  @Override
  public EList<State> getState() {
    if (state_ == null)
    	state_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getState(), adaptersFactory, eResource);
    return state_;
  }
  
  private EList<Transition> transition_;
  
  @Override
  public EList<Transition> getTransition() {
    if (transition_ == null)
    	transition_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getTransition(), adaptersFactory, eResource);
    return transition_;
  }
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.eINSTANCE.getStateMachineConstraint();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__CONSTRAINED_MODE:
    		return getConstrainedMode();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__RELATED_VEHICLE_FEATURE:
    		return getRelatedVehicleFeature();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__CONSTRAINED_FUNCTION_BEHAVIOR:
    		return getConstrainedFunctionBehavior();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__CONSTRAINED_ERROR_BEHAVIOR:
    		return getConstrainedErrorBehavior();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__CONSTRAINED_FUNCTION_TRIGGER:
    		return getConstrainedFunctionTrigger();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__STATE:
    		return getState();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__TRANSITION:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.STATE_MACHINE_CONSTRAINT__TRANSITION:
    		return getTransition() != null && !getTransition().isEmpty();
    }
