...
public class ParameterConstraintAdapter extends EObjectAdapter<ParameterConstraint> implements fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.ParameterConstraint {
  private EastADLMTAdaptersFactory adaptersFactory;
  
  public ParameterConstraintAdapter() {
  ...
  private EList<Parameter> parameter_;
  
  @Override
  public EList<Parameter> getParameter() {
    if (parameter_ == null)
    	parameter_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getParameter(), adaptersFactory, eResource);
    return parameter_;
  }
  
  private EList<ParameterCondition> parameterCondition_;
  
  @Override
  public EList<ParameterCondition> getParameterCondition() {
    if (parameterCondition_ == null)
    	parameterCondition_ = fr.inria.diverse.melange.adapters.EListAdapter.newInstance(adaptee.getParameterCondition(), adaptersFactory, eResource);
    return parameterCondition_;
  }
  ...
  public EClass eClass() {
    return fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.eINSTANCE.getParameterConstraint();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__GSHORT_NAME:
    		return getGShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__SHORT_NAME:
    		return getShortName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__CATEGORY:
    		return getCategory();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__UUID:
    		return getUuid();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__NAME:
    		return getName();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__OWNED_COMMENT:
    		return getOwnedComment();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__CONSTRAINED_MODE:
    		return getConstrainedMode();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__RELATED_VEHICLE_FEATURE:
    		return getRelatedVehicleFeature();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__CONSTRAINED_FUNCTION_BEHAVIOR:
    		return getConstrainedFunctionBehavior();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__CONSTRAINED_ERROR_BEHAVIOR:
    		return getConstrainedErrorBehavior();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__CONSTRAINED_FUNCTION_TRIGGER:
    		return getConstrainedFunctionTrigger();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__PARAMETER:
    		return getParameter();
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__PARAMETER_CONDITION:
  ...
  public boolean eIsSet(final int featureID) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__PARAMETER_CONDITION:
    		return getParameterCondition() != null && !getParameterCondition().isEmpty();
    }
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	...
    	case fr.inria.aoste.executable.eastadl.eastadlmt.eastadl21.east_adl.annexes.behaviorconstraints.BehaviorconstraintsPackage.PARAMETER_CONSTRAINT__PARAMETER_CONDITION:
    		...
    		getParameterCondition().addAll((Collection) newValue);
    		return;
    }
