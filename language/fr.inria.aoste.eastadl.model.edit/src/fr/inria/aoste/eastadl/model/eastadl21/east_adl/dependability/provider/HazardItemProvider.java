...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.Hazard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HazardItemProvider extends TraceableSpecificationItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMalfunctionPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Malfunction feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMalfunctionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hazard_malfunction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hazard_malfunction_feature", "_UI_Hazard_type"),
				 DependabilityPackage.Literals.HAZARD__MALFUNCTION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addItemPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hazard_item_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hazard_item_feature", "_UI_Hazard_type"),
				 DependabilityPackage.Literals.HAZARD__ITEM,
				 true,
				 false,
				 true,
				 null,
