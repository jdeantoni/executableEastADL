...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.infrastructure.userattributes.UserAttributeDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserAttributeDefinitionItemProvider extends EAElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UserAttributeDefinition_defaultValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UserAttributeDefinition_defaultValue_feature", "_UI_UserAttributeDefinition_type"),
				 UserattributesPackage.Literals.USER_ATTRIBUTE_DEFINITION__DEFAULT_VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UserattributesPackage.Literals.USER_ATTRIBUTE_DEFINITION__TYPE,
				 true,
				 false,
				 true,
				 null,
