...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.timing.timingconstraints.EventConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventConstraintItemProvider extends TimingConstraintItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EventConstraintItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventConstraint_event_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventConstraint_event_feature", "_UI_EventConstraint_type"),
				 TimingconstraintsPackage.Literals.EVENT_CONSTRAINT__EVENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TimingconstraintsPackage.Literals.EVENT_CONSTRAINT__OFFSET);
		}
	...
	public String getText(Object object) {
		String label = ((EventConstraint)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EventConstraint_type") :
			getString("_UI_EventConstraint_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EventConstraint.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TimingconstraintsPackage.Literals.EVENT_CONSTRAINT__OFFSET,
