...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.behavior.Behavior} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BehaviorItemProvider extends ContextItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BehaviorPackage.Literals.BEHAVIOR__MODE_GROUP);
			childrenFeatures.add(BehaviorPackage.Literals.BEHAVIOR__BEHAVIOR);
			childrenFeatures.add(BehaviorPackage.Literals.BEHAVIOR__FUNCTION_TRIGGER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.BEHAVIOR__MODE_GROUP,
				 BehaviorFactory.eINSTANCE.createModeGroup()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.BEHAVIOR__BEHAVIOR,
				 BehaviorFactory.eINSTANCE.createFunctionBehavior()));

		newChildDescriptors.add
			(createChildParameter
				(BehaviorPackage.Literals.BEHAVIOR__FUNCTION_TRIGGER,
				 BehaviorFactory.eINSTANCE.createFunctionTrigger()));
	}
