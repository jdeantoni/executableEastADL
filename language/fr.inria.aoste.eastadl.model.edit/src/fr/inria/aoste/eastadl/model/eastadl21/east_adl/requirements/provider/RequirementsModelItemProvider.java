...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.requirements.RequirementsModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementsModelItemProvider extends ContextItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RequirementsPackage.Literals.REQUIREMENTS_MODEL__OPERATIONAL_SITUATION);
			childrenFeatures.add(RequirementsPackage.Literals.REQUIREMENTS_MODEL__REQUIREMENT);
			childrenFeatures.add(RequirementsPackage.Literals.REQUIREMENTS_MODEL__REQUIREMENT_CONTAINER);
			childrenFeatures.add(RequirementsPackage.Literals.REQUIREMENTS_MODEL__USE_CASE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RequirementsPackage.Literals.REQUIREMENTS_MODEL__OPERATIONAL_SITUATION,
				 RequirementsFactory.eINSTANCE.createOperationalSituation()));

		newChildDescriptors.add
			(createChildParameter
				(RequirementsPackage.Literals.REQUIREMENTS_MODEL__REQUIREMENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(RequirementsPackage.Literals.REQUIREMENTS_MODEL__REQUIREMENT_CONTAINER,
		...
		newChildDescriptors.add
			(createChildParameter
				(RequirementsPackage.Literals.REQUIREMENTS_MODEL__USE_CASE,
