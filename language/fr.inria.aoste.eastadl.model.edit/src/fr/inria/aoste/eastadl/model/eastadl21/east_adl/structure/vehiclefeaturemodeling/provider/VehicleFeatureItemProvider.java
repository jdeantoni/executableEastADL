...
import fr.inria.aoste.eastadl.model.eastadl21.east_adl.structure.featuremodeling.provider.FeatureItemProvider;
...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.structure.vehiclefeaturemodeling.VehicleFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VehicleFeatureItemProvider extends FeatureItemProvider {
	/**
	 ...
	 * @generated
	 */
	protected void addIsDesignVariabilityRationalePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VehicleFeature_isDesignVariabilityRationale_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VehicleFeature_isDesignVariabilityRationale_feature", "_UI_VehicleFeature_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_VehicleFeature_isCustomerVisible_feature", "_UI_VehicleFeature_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VehiclefeaturemodelingPackage.Literals.VEHICLE_FEATURE__DEVIATION_ATTRIBUTE_SET);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VehicleFeature"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_VehicleFeature_type") :
		...
		newChildDescriptors.add
			(createChildParameter
				(VehiclefeaturemodelingPackage.Literals.VEHICLE_FEATURE__DEVIATION_ATTRIBUTE_SET,
				 VehiclefeaturemodelingFactory.eINSTANCE.createDeviationAttributeSet()));
	}
