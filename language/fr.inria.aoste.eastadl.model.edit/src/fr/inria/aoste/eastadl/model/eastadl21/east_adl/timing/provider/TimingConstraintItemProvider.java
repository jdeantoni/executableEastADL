...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.timing.TimingConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimingConstraintItemProvider extends EAElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimingConstraint_mode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimingConstraint_mode_feature", "_UI_TimingConstraint_type"),
				 TimingPackage.Literals.TIMING_CONSTRAINT__MODE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TimingPackage.Literals.TIMING_CONSTRAINT__LOWER);
			childrenFeatures.add(TimingPackage.Literals.TIMING_CONSTRAINT__UPPER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TimingPackage.Literals.TIMING_CONSTRAINT__LOWER,
				 TimingFactory.eINSTANCE.createTimeDuration()));

		newChildDescriptors.add
			(createChildParameter
				(TimingPackage.Literals.TIMING_CONSTRAINT__UPPER,
				 TimingFactory.eINSTANCE.createTimeDuration()));
	}
