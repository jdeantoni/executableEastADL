...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.structure.hardwaremodeling.HardwareComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HardwareComponentTypeItemProvider extends ContextItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HardwaremodelingPackage.Literals.HARDWARE_COMPONENT_TYPE__CONNECTOR);
			childrenFeatures.add(HardwaremodelingPackage.Literals.HARDWARE_COMPONENT_TYPE__PORT);
			childrenFeatures.add(HardwaremodelingPackage.Literals.HARDWARE_COMPONENT_TYPE__PART);
			childrenFeatures.add(HardwaremodelingPackage.Literals.HARDWARE_COMPONENT_TYPE__PORT_GROUP);
			childrenFeatures.add(HardwaremodelingPackage.Literals.HARDWARE_COMPONENT_TYPE__BUS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(HardwaremodelingPackage.Literals.HARDWARE_COMPONENT_TYPE__PORT,
				 HardwaremodelingFactory.eINSTANCE.createCommunicationHardwarePin()));

		newChildDescriptors.add
			(createChildParameter
				(HardwaremodelingPackage.Literals.HARDWARE_COMPONENT_TYPE__PORT,
				 HardwaremodelingFactory.eINSTANCE.createIOHardwarePin()));

		newChildDescriptors.add
			(createChildParameter
				(HardwaremodelingPackage.Literals.HARDWARE_COMPONENT_TYPE__PORT,
				 HardwaremodelingFactory.eINSTANCE.createPowerHardwarePin()));
