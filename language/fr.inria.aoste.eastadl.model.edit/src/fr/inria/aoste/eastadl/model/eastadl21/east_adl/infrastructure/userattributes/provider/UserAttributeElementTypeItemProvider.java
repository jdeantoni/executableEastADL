...
import fr.inria.aoste.eastadl.model.eastadl21.east_adl.infrastructure.elements.provider.EAPackageableElementItemProvider;
...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.infrastructure.userattributes.UserAttributeElementType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserAttributeElementTypeItemProvider extends EAPackageableElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_UserAttributeElementType_validFor_feature", "_UI_UserAttributeElementType_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_UserAttributeElementType_extendedElementType_feature", "_UI_UserAttributeElementType_type"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UserattributesPackage.Literals.USER_ATTRIBUTE_ELEMENT_TYPE__ATTRIBUTE);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UserAttributeElementType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UserAttributeElementType_type") :
		...
		newChildDescriptors.add
			(createChildParameter
				(UserattributesPackage.Literals.USER_ATTRIBUTE_ELEMENT_TYPE__ATTRIBUTE,
				 UserattributesFactory.eINSTANCE.createUserAttributeDefinition()));
	}
