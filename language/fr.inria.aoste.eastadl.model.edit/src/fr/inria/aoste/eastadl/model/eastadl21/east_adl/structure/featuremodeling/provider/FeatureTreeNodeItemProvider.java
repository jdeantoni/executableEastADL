...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.structure.featuremodeling.FeatureTreeNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureTreeNodeItemProvider extends ContextItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FeatureTreeNodeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((FeatureTreeNode)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FeatureTreeNode_type") :
			getString("_UI_FeatureTreeNode_type") + " " + label;
	}
