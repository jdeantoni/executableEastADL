...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.infrastructure.elements.Realization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RealizationItemProvider extends RelationshipItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ElementsPackage.Literals.REALIZATION__REALIZED);
			childrenFeatures.add(ElementsPackage.Literals.REALIZATION__REALIZED_BY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ElementsPackage.Literals.REALIZATION__REALIZED,
				 _instancerefFactory.eINSTANCE.createRealization_realized()));

		newChildDescriptors.add
			(createChildParameter
				(ElementsPackage.Literals.REALIZATION__REALIZED_BY,
				 _instancerefFactory.eINSTANCE.createRealization_realizedBy()));
	}
