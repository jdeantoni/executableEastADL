...
/**
 * This is the item provider adapter for a {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.structure.systemmodeling.VehicleLevel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VehicleLevelItemProvider extends ContextItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VehicleLevelItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SystemmodelingPackage.Literals.VEHICLE_LEVEL__TECHNICAL_FEATURE_MODEL);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VehicleLevel"));
	}
	...
	public String getText(Object object) {
		String label = ((VehicleLevel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VehicleLevel_type") :
			getString("_UI_VehicleLevel_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VehicleLevel.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SystemmodelingPackage.Literals.VEHICLE_LEVEL__TECHNICAL_FEATURE_MODEL,
