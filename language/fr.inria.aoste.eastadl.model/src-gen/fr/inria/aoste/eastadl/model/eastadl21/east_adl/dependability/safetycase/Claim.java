 ...
 * <ul>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.Claim#getEvidence <em>Evidence</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.Claim#getJustification <em>Justification</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.Claim#getSupportedArgument <em>Supported Argument</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.Claim#getSafetyRequirement <em>Safety Requirement</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.Claim#getGoalDecompositionStrategy <em>Goal Decomposition Strategy</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.SafetycasePackage#getClaim()
 * @model
 * @generated
 */
public interface Claim extends TraceableSpecification {
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.SafetycasePackage#getClaim_Evidence()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.infrastructure.elements.Rationale}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.SafetycasePackage#getClaim_Justification()
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.SafetycasePackage#getClaim_SupportedArgument()
	 * @model
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.infrastructure.elements.TraceableSpecification}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.SafetycasePackage#getClaim_SafetyRequirement()
	 * @model
	 * @generated
	 */
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.dependability.safetycase.SafetycasePackage#getClaim_GoalDecompositionStrategy()
	 * @model
	 * @generated
	 */
