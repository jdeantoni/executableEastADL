/**
 */
package fr.inria.aoste.eastadl.model.eastadl21.autosar.genericstructure.generaltemplateclasses.impl;
...
import fr.inria.aoste.eastadl.model.eastadl21.autosar.genericstructure.generaltemplateclasses.GeneraltemplateclassesFactory;
 ...
 * @generated
 */
public class GeneraltemplateclassesPackageImpl extends EPackageImpl implements GeneraltemplateclassesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.autosar.genericstructure.generaltemplateclasses.GeneraltemplateclassesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GeneraltemplateclassesPackageImpl() {
		super(eNS_URI, GeneraltemplateclassesFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GeneraltemplateclassesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GeneraltemplateclassesPackage init() {
		if (isInited) return (GeneraltemplateclassesPackage)EPackage.Registry.INSTANCE.getEPackage(GeneraltemplateclassesPackage.eNS_URI);

		// Obtain or create and register package
		GeneraltemplateclassesPackageImpl theGeneraltemplateclassesPackage = (GeneraltemplateclassesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GeneraltemplateclassesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GeneraltemplateclassesPackageImpl());
		...
		theGeneraltemplateclassesPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GeneraltemplateclassesPackage.eNS_URI, theGeneraltemplateclassesPackage);
		return theGeneraltemplateclassesPackage;
	}
	...
	public GeneraltemplateclassesFactory getGeneraltemplateclassesFactory() {
		return (GeneraltemplateclassesFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theTimevaluePackage);
		getESubpackages().add(theIdentifiablePackage);
