 ...
 * <ul>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.BusinessOpportunity#getBusinessOpportunity <em>Business Opportunity</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.BusinessOpportunity#getMotivatesDevelopmentOf <em>Motivates Development Of</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.BusinessOpportunity#getProductPositioning <em>Product Positioning</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.BusinessOpportunity#getProblemStatement <em>Problem Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.NeedsPackage#getBusinessOpportunity()
 * @model
 * @generated
 */
public interface BusinessOpportunity extends TraceableSpecification {
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.NeedsPackage#getBusinessOpportunity_BusinessOpportunity()
	...
	/**
	 * Sets the value of the '{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.BusinessOpportunity#getBusinessOpportunity <em>Business Opportunity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.BusinessOpportunity#getBusinessOpportunity <em>Business Opportunity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetBusinessOpportunity()
	 * @see #getBusinessOpportunity()
	...
	/**
	 * Returns whether the value of the '{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.BusinessOpportunity#getBusinessOpportunity <em>Business Opportunity</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.NeedsPackage#getBusinessOpportunity_MotivatesDevelopmentOf()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.ProductPositioning}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.NeedsPackage#getBusinessOpportunity_ProductPositioning()
	 * @model
	 * @generated
	 */
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.needs.NeedsPackage#getBusinessOpportunity_ProblemStatement()
	 * @model
	 * @generated
	 */
