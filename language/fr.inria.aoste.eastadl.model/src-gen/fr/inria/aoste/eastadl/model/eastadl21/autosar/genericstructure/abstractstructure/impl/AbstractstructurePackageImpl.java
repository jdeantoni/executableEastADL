...
import fr.inria.aoste.eastadl.model.eastadl21.autosar.genericstructure.abstractstructure.AbstractstructureFactory;
...
import fr.inria.aoste.eastadl.model.eastadl21.autosar.genericstructure.abstractstructure.AtpType;
 ...
 * @generated
 */
public class AbstractstructurePackageImpl extends EPackageImpl implements AbstractstructurePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass atpClassifierEClass = null;
	 ...
	 * @generated
	 */
	private EClass atpFeatureEClass = null;
	 ...
	 * @generated
	 */
	private EClass atpInstanceRefEClass = null;
	 ...
	 * @generated
	 */
	private EClass atpPrototypeEClass = null;
	 ...
	 * @generated
	 */
	private EClass atpStructureElementEClass = null;
	 ...
	 * @generated
	 */
	private EClass atpTypeEClass = null;
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.autosar.genericstructure.abstractstructure.AbstractstructurePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AbstractstructurePackageImpl() {
		super(eNS_URI, AbstractstructureFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AbstractstructurePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AbstractstructurePackage init() {
		if (isInited) return (AbstractstructurePackage)EPackage.Registry.INSTANCE.getEPackage(AbstractstructurePackage.eNS_URI);

		// Obtain or create and register package
		AbstractstructurePackageImpl theAbstractstructurePackage = (AbstractstructurePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AbstractstructurePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AbstractstructurePackageImpl());
		...
		theAbstractstructurePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AbstractstructurePackage.eNS_URI, theAbstractstructurePackage);
		return theAbstractstructurePackage;
	}
	 ...
	 * @generated
	 */
	public EClass getAtpClassifier() {
		return atpClassifierEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getAtpClassifier_AtpFeature() {
		return (EReference)atpClassifierEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getAtpFeature() {
		return atpFeatureEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getAtpInstanceRef() {
		return atpInstanceRefEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getAtpInstanceRef_AtpBase() {
		return (EReference)atpInstanceRefEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getAtpInstanceRef_AtpContextElement() {
		return (EReference)atpInstanceRefEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getAtpInstanceRef_AtpTarget() {
		return (EReference)atpInstanceRefEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getAtpPrototype() {
		return atpPrototypeEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getAtpPrototype_AtpType() {
		return (EReference)atpPrototypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getAtpStructureElement() {
		return atpStructureElementEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getAtpType() {
		return atpTypeEClass;
	}
	...
	public AbstractstructureFactory getAbstractstructureFactory() {
		return (AbstractstructureFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		atpClassifierEClass = createEClass(ATP_CLASSIFIER);
		createEReference(atpClassifierEClass, ATP_CLASSIFIER__ATP_FEATURE);

		atpFeatureEClass = createEClass(ATP_FEATURE);

		atpInstanceRefEClass = createEClass(ATP_INSTANCE_REF);
		createEReference(atpInstanceRefEClass, ATP_INSTANCE_REF__ATP_BASE);
		createEReference(atpInstanceRefEClass, ATP_INSTANCE_REF__ATP_CONTEXT_ELEMENT);
		createEReference(atpInstanceRefEClass, ATP_INSTANCE_REF__ATP_TARGET);

		atpPrototypeEClass = createEClass(ATP_PROTOTYPE);
		createEReference(atpPrototypeEClass, ATP_PROTOTYPE__ATP_TYPE);

		atpStructureElementEClass = createEClass(ATP_STRUCTURE_ELEMENT);

		atpTypeEClass = createEClass(ATP_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		atpClassifierEClass.getESuperTypes().add(theIdentifiablePackage.getIdentifiable());
		atpFeatureEClass.getESuperTypes().add(theIdentifiablePackage.getIdentifiable());
		atpPrototypeEClass.getESuperTypes().add(this.getAtpFeature());
		atpStructureElementEClass.getESuperTypes().add(this.getAtpFeature());
		atpStructureElementEClass.getESuperTypes().add(this.getAtpClassifier());
		atpTypeEClass.getESuperTypes().add(this.getAtpClassifier());

		// Initialize classes, features, and operations; add parameters
		initEClass(atpClassifierEClass, AtpClassifier.class, "AtpClassifier", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAtpClassifier_AtpFeature(), this.getAtpFeature(), null, "atpFeature", null, 0, -1, AtpClassifier.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(atpFeatureEClass, AtpFeature.class, "AtpFeature", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(atpInstanceRefEClass, AtpInstanceRef.class, "AtpInstanceRef", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAtpInstanceRef_AtpBase(), this.getAtpClassifier(), null, "atpBase", null, 1, 1, AtpInstanceRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getAtpInstanceRef_AtpContextElement(), this.getAtpFeature(), null, "atpContextElement", null, 0, -1, AtpInstanceRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getAtpInstanceRef_AtpTarget(), this.getAtpFeature(), null, "atpTarget", null, 1, 1, AtpInstanceRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(atpPrototypeEClass, AtpPrototype.class, "AtpPrototype", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAtpPrototype_AtpType(), this.getAtpType(), null, "atpType", null, 1, 1, AtpPrototype.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(atpStructureElementEClass, AtpStructureElement.class, "AtpStructureElement", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(atpTypeEClass, AtpType.class, "AtpType", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}

} //AbstractstructurePackageImpl
