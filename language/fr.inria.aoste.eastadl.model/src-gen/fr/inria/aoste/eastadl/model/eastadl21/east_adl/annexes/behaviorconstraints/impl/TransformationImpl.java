 ...
 * <ul>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.behaviorconstraints.impl.TransformationImpl#getPostCondition <em>Post Condition</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.behaviorconstraints.impl.TransformationImpl#getOutgoingFlow <em>Outgoing Flow</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.behaviorconstraints.impl.TransformationImpl#getIncomingFlow <em>Incoming Flow</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.behaviorconstraints.impl.TransformationImpl#getInOut <em>In Out</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.behaviorconstraints.impl.TransformationImpl#getPreCondition <em>Pre Condition</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.behaviorconstraints.impl.TransformationImpl#getInvariantCondition <em>Invariant Condition</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.behaviorconstraints.impl.TransformationImpl#getSubComputationConstraint <em>Sub Computation Constraint</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.behaviorconstraints.impl.TransformationImpl#getIn <em>In</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.east_adl.annexes.behaviorconstraints.impl.TransformationImpl#getOut <em>Out</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
