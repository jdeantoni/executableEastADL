/**
 */
package fr.inria.aoste.eastadl.model.eastadl21.autosar.genericstructure.generaltemplateclasses.identifiable.impl;
 ...
 * <ul>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.autosar.genericstructure.generaltemplateclasses.identifiable.impl.IdentifiableImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.model.eastadl21.autosar.genericstructure.generaltemplateclasses.identifiable.impl.IdentifiableImpl#getUuid <em>Uuid</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IdentifiableImpl extends ReferrableImpl implements Identifiable {
	...
	public void setCategory(String newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdentifiablePackage.IDENTIFIABLE__CATEGORY, oldCategory, category, !oldCategoryESet));
	}
	...
	public void unsetCategory() {
		...
		categoryESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IdentifiablePackage.IDENTIFIABLE__CATEGORY, oldCategory, CATEGORY_EDEFAULT, oldCategoryESet));
	}
	...
	public void setUuid(String newUuid) {
		...
		uuidESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdentifiablePackage.IDENTIFIABLE__UUID, oldUuid, uuid, !oldUuidESet));
	}
	...
	public void unsetUuid() {
		...
		uuidESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IdentifiablePackage.IDENTIFIABLE__UUID, oldUuid, UUID_EDEFAULT, oldUuidESet));
	}
