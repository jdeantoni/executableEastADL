...
import fr.inria.aoste.eastadl.model.eastadl21.east_adl.structure.functionmodeling.BasicSoftwareFunctionType;
import fr.inria.aoste.eastadl.model.eastadl21.east_adl.structure.functionmodeling.ClientServerKind;
...
public class FunctionmodelingPackageImpl extends EPackageImpl implements FunctionmodelingPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.model.eastadl21.east_adl.structure.functionmodeling.FunctionmodelingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EOperation getFunctionPrototype__Start() {
	 ...
	 * @generated
	 */
	public EOperation getFunctionPrototype__Stop() {
		return functionPrototypeEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getFunctionPortProxy__Read() {
		return functionPortProxyEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getFunctionPortProxy__Write() {
		return functionPortProxyEClass.getEOperations().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(functionPrototypeEClass, FUNCTION_PROTOTYPE___START);
		createEOperation(functionPrototypeEClass, FUNCTION_PROTOTYPE___STOP);
		...
		createEOperation(functionPortProxyEClass, FUNCTION_PORT_PROXY___READ);
		createEOperation(functionPortProxyEClass, FUNCTION_PORT_PROXY___WRITE);
	...
	public void initializePackageContents() {
		...
		initEOperation(getFunctionPrototype__Start(), null, "start", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getFunctionPrototype__Stop(), null, "stop", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getFunctionPortProxy__Read(), null, "read", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getFunctionPortProxy__Write(), null, "write", 0, 1, IS_UNIQUE, IS_ORDERED);
