...
import fr.inria.aoste.eastadl.model.geastadl.ginfrastructure.gelements.GelementsFactory;
...
public class GelementsPackageImpl extends EPackageImpl implements GelementsPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.model.geastadl.ginfrastructure.gelements.GelementsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(geaxmlEClass, fr.inria.aoste.eastadl.model.geastadl.ginfrastructure.gelements.GEAXML.class, "GEAXML", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGEAXML_GTopLevelPackage(), this.getGEAPackage(), null, "gTopLevelPackage", null, 0, -1, fr.inria.aoste.eastadl.model.geastadl.ginfrastructure.gelements.GEAXML.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
