 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.infrastructure.elements._instanceref.impl.Realization_realizedByImpl#getIdentifiable_context <em>Identifiable context</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.infrastructure.elements._instanceref.impl.Realization_realizedByImpl#getIdentifiable_target <em>Identifiable target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Realization_realizedByImpl extends EObjectImpl implements Realization_realizedBy {
	/**
	...
	protected EClass eStaticClass() {
		return _instancerefPackage.Literals.REALIZATION_REALIZED_BY;
	}
	...
	public EList<Identifiable> getIdentifiable_context() {
		if (identifiable_context == null) {
			identifiable_context = new EObjectResolvingEList<Identifiable>(Identifiable.class, this, _instancerefPackage.REALIZATION_REALIZED_BY__IDENTIFIABLE_CONTEXT);
		}
		...
		if (identifiable_target != null && identifiable_target.eIsProxy()) {
			...
			if (identifiable_target != oldIdentifiable_target) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, _instancerefPackage.REALIZATION_REALIZED_BY__IDENTIFIABLE_TARGET, oldIdentifiable_target, identifiable_target));
			}
		}
	...
	public void setIdentifiable_target(Identifiable newIdentifiable_target) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _instancerefPackage.REALIZATION_REALIZED_BY__IDENTIFIABLE_TARGET, oldIdentifiable_target, identifiable_target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _instancerefPackage.REALIZATION_REALIZED_BY__IDENTIFIABLE_CONTEXT:
				return getIdentifiable_context();
			case _instancerefPackage.REALIZATION_REALIZED_BY__IDENTIFIABLE_TARGET:
