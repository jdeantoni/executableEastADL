 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref.impl.FaultFailurePropagationLink_fromPortImpl#getFaultFailurePort <em>Fault Failure Port</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref.impl.FaultFailurePropagationLink_fromPortImpl#getErrorModelPrototype <em>Error Model Prototype</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref.impl.FaultFailurePropagationLink_fromPortImpl#getFaultFailurePortProxy <em>Fault Failure Port Proxy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FaultFailurePropagationLink_fromPortImpl extends EObjectImpl implements FaultFailurePropagationLink_fromPort {
	/**
	...
	protected EClass eStaticClass() {
		return _instancerefPackage.Literals.FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT;
	}
		...
		if (faultFailurePort != null && faultFailurePort.eIsProxy()) {
			...
			if (faultFailurePort != oldFaultFailurePort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, _instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__FAULT_FAILURE_PORT, oldFaultFailurePort, faultFailurePort));
			}
		}
	...
	public void setFaultFailurePort(FaultFailurePort newFaultFailurePort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__FAULT_FAILURE_PORT, oldFaultFailurePort, faultFailurePort));
	}
	...
	public EList<ErrorModelPrototype> getErrorModelPrototype() {
		if (errorModelPrototype == null) {
			errorModelPrototype = new EObjectResolvingEList<ErrorModelPrototype>(ErrorModelPrototype.class, this, _instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__ERROR_MODEL_PROTOTYPE);
		}
	...
	public FaultFailurePortProxy getFaultFailurePortProxy() {
		if (faultFailurePortProxy != null && faultFailurePortProxy.eIsProxy()) {
			...
			if (faultFailurePortProxy != oldFaultFailurePortProxy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, _instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__FAULT_FAILURE_PORT_PROXY, oldFaultFailurePortProxy, faultFailurePortProxy));
			}
		}
	...
	public void setFaultFailurePortProxy(FaultFailurePortProxy newFaultFailurePortProxy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__FAULT_FAILURE_PORT_PROXY, oldFaultFailurePortProxy, faultFailurePortProxy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__FAULT_FAILURE_PORT:
				if (resolve) return getFaultFailurePort();
				return basicGetFaultFailurePort();
			case _instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__ERROR_MODEL_PROTOTYPE:
				return getErrorModelPrototype();
			case _instancerefPackage.FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__FAULT_FAILURE_PORT_PROXY:
