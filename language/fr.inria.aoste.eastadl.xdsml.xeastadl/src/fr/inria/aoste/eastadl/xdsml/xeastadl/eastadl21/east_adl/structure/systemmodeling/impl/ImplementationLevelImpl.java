...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.structure.systemmodeling.ImplementationLevel;
 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.structure.systemmodeling.impl.ImplementationLevelImpl#getAutosarSystem <em>Autosar System</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImplementationLevelImpl extends ContextImpl implements ImplementationLevel {
	 ...
	 * @ordered
	 */
	protected fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System autosarSystem;
	 ...
	 * @generated
	 */
	public fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System getAutosarSystem() {
		if (autosarSystem != null && autosarSystem.eIsProxy()) {
			InternalEObject oldAutosarSystem = (InternalEObject)autosarSystem;
			autosarSystem = (fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System)eResolveProxy(oldAutosarSystem);
	 ...
	 * @generated
	 */
	public fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System basicGetAutosarSystem() {
		return autosarSystem;
	}
	 ...
	 * @generated
	 */
	public void setAutosarSystem(fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System newAutosarSystem) {
		fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System oldAutosarSystem = autosarSystem;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SystemmodelingPackage.IMPLEMENTATION_LEVEL__AUTOSAR_SYSTEM:
				setAutosarSystem((fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case SystemmodelingPackage.IMPLEMENTATION_LEVEL__AUTOSAR_SYSTEM:
				setAutosarSystem((fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System)null);
				return;
		}
