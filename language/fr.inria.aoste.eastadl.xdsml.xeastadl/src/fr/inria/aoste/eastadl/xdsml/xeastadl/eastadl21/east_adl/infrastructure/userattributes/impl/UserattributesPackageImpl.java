...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.infrastructure.userattributes.UserAttributeableElement;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.infrastructure.userattributes.UserattributesFactory;
...
public class UserattributesPackageImpl extends EPackageImpl implements UserattributesPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.infrastructure.userattributes.UserattributesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EAttribute getUserAttributeDefinition_DefaultValue() {
		return (EAttribute)userAttributeDefinitionEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getUserAttributeElementType_ValidFor() {
		return (EAttribute)userAttributeElementTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getUserAttributeValue_Semantics() {
		return (EAttribute)userAttributeValueEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(userAttributeValueEClass, USER_ATTRIBUTE_VALUE__SEMANTICS);
	...
	public void initializePackageContents() {
		...
		userAttributeElementTypeEClass.getESuperTypes().add(theElementsPackage.getEAPackageableElement());
		...
		initEReference(getUserAttributeableElement_AttributedElement(), theIdentifiablePackage.getIdentifiable(), null, "attributedElement", null, 1, 1, UserAttributeableElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUserAttributeDefinition_DefaultValue(), thePrimitivetypesPackage.getString(), "defaultValue", "", 0, 1, UserAttributeDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUserAttributeElementType_ValidFor(), thePrimitivetypesPackage.getString(), "validFor", "", 0, 1, UserAttributeElementType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUserAttributeValue_Semantics(), thePrimitivetypesPackage.getString(), "semantics", "", 0, 1, UserAttributeValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUserAttributeValue_Value(), thePrimitivetypesPackage.getString(), "value", "", 1, 1, UserAttributeValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
