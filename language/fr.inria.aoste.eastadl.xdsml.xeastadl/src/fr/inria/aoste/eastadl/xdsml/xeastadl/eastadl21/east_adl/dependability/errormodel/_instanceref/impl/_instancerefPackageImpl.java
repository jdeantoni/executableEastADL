...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref.ErrorModelPrototype_functionTarget;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref.ErrorModelPrototype_hwTarget;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref.FaultFailurePort_functionTarget;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref.FaultFailurePort_hwTarget;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref.FaultFailurePropagationLink_fromPort;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref.FaultFailurePropagationLink_toPort;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref._instancerefFactory;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref._instancerefPackage;
...
public class _instancerefPackageImpl extends EPackageImpl implements _instancerefPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.errormodel._instanceref._instancerefPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static _instancerefPackage init() {
		...
		fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.structure.functionmodeling._instanceref.impl._instancerefPackageImpl the_instancerefPackage_1 = (fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.structure.functionmodeling._instanceref.impl._instancerefPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.structure.functionmodeling._instanceref._instancerefPackage.eNS_URI) instanceof fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.structure.functionmodeling._instanceref.impl._instancerefPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.structure.functionmodeling._instanceref._instancerefPackage.eNS_URI) : fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.structure.functionmodeling._instanceref._instancerefPackage.eINSTANCE);
	...
	public EReference getErrorModelPrototype_functionTarget_FunctionPrototype() {
		return (EReference)errorModelPrototype_functionTargetEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getErrorModelPrototype_functionTarget_FunctionPrototype_context() {
		return (EReference)errorModelPrototype_functionTargetEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getErrorModelPrototype_hwTarget_HardwareComponentPrototype_context() {
		return (EReference)errorModelPrototype_hwTargetEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getErrorModelPrototype_hwTarget_HardwareComponentPrototype() {
		return (EReference)errorModelPrototype_hwTargetEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getFaultFailurePort_functionTarget_FunctionPort() {
		return (EReference)faultFailurePort_functionTargetEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getFaultFailurePort_functionTarget_FunctionPrototype() {
		return (EReference)faultFailurePort_functionTargetEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getFaultFailurePort_hwTarget_HardwarePort() {
		return (EReference)faultFailurePort_hwTargetEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getFaultFailurePort_hwTarget_HardwareComponentPrototype() {
		return (EReference)faultFailurePort_hwTargetEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getFaultFailurePropagationLink_fromPort_FaultFailurePort() {
		return (EReference)faultFailurePropagationLink_fromPortEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getFaultFailurePropagationLink_fromPort_ErrorModelPrototype() {
		return (EReference)faultFailurePropagationLink_fromPortEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFaultFailurePropagationLink_fromPort_FaultFailurePortProxy() {
		return (EReference)faultFailurePropagationLink_fromPortEClass.getEStructuralFeatures().get(2);
	}
	...
	public EReference getFaultFailurePropagationLink_toPort_FaultFailurePort() {
		return (EReference)faultFailurePropagationLink_toPortEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getFaultFailurePropagationLink_toPort_ErrorModelPrototype() {
		return (EReference)faultFailurePropagationLink_toPortEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFaultFailurePropagationLink_toPort_FaultFailurePortProxy() {
		return (EReference)faultFailurePropagationLink_toPortEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		errorModelPrototype_functionTargetEClass = createEClass(ERROR_MODEL_PROTOTYPE_FUNCTION_TARGET);
		createEReference(errorModelPrototype_functionTargetEClass, ERROR_MODEL_PROTOTYPE_FUNCTION_TARGET__FUNCTION_PROTOTYPE);
		createEReference(errorModelPrototype_functionTargetEClass, ERROR_MODEL_PROTOTYPE_FUNCTION_TARGET__FUNCTION_PROTOTYPE_CONTEXT);

		errorModelPrototype_hwTargetEClass = createEClass(ERROR_MODEL_PROTOTYPE_HW_TARGET);
		createEReference(errorModelPrototype_hwTargetEClass, ERROR_MODEL_PROTOTYPE_HW_TARGET__HARDWARE_COMPONENT_PROTOTYPE_CONTEXT);
		createEReference(errorModelPrototype_hwTargetEClass, ERROR_MODEL_PROTOTYPE_HW_TARGET__HARDWARE_COMPONENT_PROTOTYPE);

		faultFailurePort_functionTargetEClass = createEClass(FAULT_FAILURE_PORT_FUNCTION_TARGET);
		createEReference(faultFailurePort_functionTargetEClass, FAULT_FAILURE_PORT_FUNCTION_TARGET__FUNCTION_PORT);
		createEReference(faultFailurePort_functionTargetEClass, FAULT_FAILURE_PORT_FUNCTION_TARGET__FUNCTION_PROTOTYPE);

		faultFailurePort_hwTargetEClass = createEClass(FAULT_FAILURE_PORT_HW_TARGET);
		createEReference(faultFailurePort_hwTargetEClass, FAULT_FAILURE_PORT_HW_TARGET__HARDWARE_PORT);
		createEReference(faultFailurePort_hwTargetEClass, FAULT_FAILURE_PORT_HW_TARGET__HARDWARE_COMPONENT_PROTOTYPE);

		faultFailurePropagationLink_fromPortEClass = createEClass(FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT);
		createEReference(faultFailurePropagationLink_fromPortEClass, FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__FAULT_FAILURE_PORT);
		createEReference(faultFailurePropagationLink_fromPortEClass, FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__ERROR_MODEL_PROTOTYPE);
		createEReference(faultFailurePropagationLink_fromPortEClass, FAULT_FAILURE_PROPAGATION_LINK_FROM_PORT__FAULT_FAILURE_PORT_PROXY);

		faultFailurePropagationLink_toPortEClass = createEClass(FAULT_FAILURE_PROPAGATION_LINK_TO_PORT);
		createEReference(faultFailurePropagationLink_toPortEClass, FAULT_FAILURE_PROPAGATION_LINK_TO_PORT__FAULT_FAILURE_PORT);
		createEReference(faultFailurePropagationLink_toPortEClass, FAULT_FAILURE_PROPAGATION_LINK_TO_PORT__ERROR_MODEL_PROTOTYPE);
		createEReference(faultFailurePropagationLink_toPortEClass, FAULT_FAILURE_PROPAGATION_LINK_TO_PORT__FAULT_FAILURE_PORT_PROXY);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(errorModelPrototype_functionTargetEClass, ErrorModelPrototype_functionTarget.class, "ErrorModelPrototype_functionTarget", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getErrorModelPrototype_functionTarget_FunctionPrototype(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype", null, 1, 1, ErrorModelPrototype_functionTarget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getErrorModelPrototype_functionTarget_FunctionPrototype_context(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype_context", null, 0, -1, ErrorModelPrototype_functionTarget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(errorModelPrototype_hwTargetEClass, ErrorModelPrototype_hwTarget.class, "ErrorModelPrototype_hwTarget", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getErrorModelPrototype_hwTarget_HardwareComponentPrototype_context(), theHardwaremodelingPackage.getHardwareComponentPrototype(), null, "hardwareComponentPrototype_context", null, 0, -1, ErrorModelPrototype_hwTarget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getErrorModelPrototype_hwTarget_HardwareComponentPrototype(), theHardwaremodelingPackage.getHardwareComponentPrototype(), null, "hardwareComponentPrototype", null, 1, 1, ErrorModelPrototype_hwTarget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(faultFailurePort_functionTargetEClass, FaultFailurePort_functionTarget.class, "FaultFailurePort_functionTarget", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFaultFailurePort_functionTarget_FunctionPort(), theFunctionmodelingPackage.getFunctionPort(), null, "functionPort", null, 1, 1, FaultFailurePort_functionTarget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFaultFailurePort_functionTarget_FunctionPrototype(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype", null, 0, -1, FaultFailurePort_functionTarget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(faultFailurePort_hwTargetEClass, FaultFailurePort_hwTarget.class, "FaultFailurePort_hwTarget", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFaultFailurePort_hwTarget_HardwarePort(), theHardwaremodelingPackage.getHardwarePin(), null, "hardwarePort", null, 1, 1, FaultFailurePort_hwTarget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFaultFailurePort_hwTarget_HardwareComponentPrototype(), theHardwaremodelingPackage.getHardwareComponentPrototype(), null, "hardwareComponentPrototype", null, 0, -1, FaultFailurePort_hwTarget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(faultFailurePropagationLink_fromPortEClass, FaultFailurePropagationLink_fromPort.class, "FaultFailurePropagationLink_fromPort", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFaultFailurePropagationLink_fromPort_FaultFailurePort(), theErrormodelPackage.getFaultFailurePort(), null, "faultFailurePort", null, 1, 1, FaultFailurePropagationLink_fromPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFaultFailurePropagationLink_fromPort_ErrorModelPrototype(), theErrormodelPackage.getErrorModelPrototype(), null, "errorModelPrototype", null, 0, -1, FaultFailurePropagationLink_fromPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFaultFailurePropagationLink_fromPort_FaultFailurePortProxy(), theErrormodelPackage.getFaultFailurePortProxy(), null, "faultFailurePortProxy", null, 1, 1, FaultFailurePropagationLink_fromPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(faultFailurePropagationLink_toPortEClass, FaultFailurePropagationLink_toPort.class, "FaultFailurePropagationLink_toPort", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFaultFailurePropagationLink_toPort_FaultFailurePort(), theErrormodelPackage.getFaultFailurePort(), null, "faultFailurePort", null, 1, 1, FaultFailurePropagationLink_toPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFaultFailurePropagationLink_toPort_ErrorModelPrototype(), theErrormodelPackage.getErrorModelPrototype(), null, "errorModelPrototype", null, 0, -1, FaultFailurePropagationLink_toPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFaultFailurePropagationLink_toPort_FaultFailurePortProxy(), theErrormodelPackage.getFaultFailurePortProxy(), null, "faultFailurePortProxy", null, 1, 1, FaultFailurePropagationLink_toPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
