 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.structure.hardwaremodeling.impl.IOHardwarePinImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IOHardwarePinImpl extends HardwarePinImpl implements IOHardwarePin {
	...
	public void setType(IOHardwarePinKind newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HardwaremodelingPackage.IO_HARDWARE_PIN__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, HardwaremodelingPackage.IO_HARDWARE_PIN__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
