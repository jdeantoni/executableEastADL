/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.impl;

import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.Eastadl21Factory;
...
public class Eastadl21PackageImpl extends EPackageImpl implements Eastadl21Package {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.Eastadl21Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		AutosarPackage theAutosarPackage = (AutosarPackage)EPackage.Registry.INSTANCE.getEPackage(AutosarPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theEast_adlPackage);
		getESubpackages().add(theAutosarPackage);
