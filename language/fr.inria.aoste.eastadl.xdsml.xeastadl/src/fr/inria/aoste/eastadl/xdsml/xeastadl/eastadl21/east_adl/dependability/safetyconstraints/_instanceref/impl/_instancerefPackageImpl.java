/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.safetyconstraints._instanceref.impl;
...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.safetyconstraints._instanceref._instancerefFactory;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.safetyconstraints._instanceref._instancerefPackage;
...
public class _instancerefPackageImpl extends EPackageImpl implements _instancerefPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.safetyconstraints._instanceref._instancerefPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getFaultFailure_anomaly_Anomaly() {
		return (EReference)faultFailure_anomalyEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getFaultFailure_anomaly_ErrorModelPrototype() {
		return (EReference)faultFailure_anomalyEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		faultFailure_anomalyEClass = createEClass(FAULT_FAILURE_ANOMALY);
		createEReference(faultFailure_anomalyEClass, FAULT_FAILURE_ANOMALY__ANOMALY);
		createEReference(faultFailure_anomalyEClass, FAULT_FAILURE_ANOMALY__ERROR_MODEL_PROTOTYPE);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(faultFailure_anomalyEClass, FaultFailure_anomaly.class, "FaultFailure_anomaly", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFaultFailure_anomaly_Anomaly(), theErrormodelPackage.getAnomaly(), null, "anomaly", null, 1, 1, FaultFailure_anomaly.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFaultFailure_anomaly_ErrorModelPrototype(), theErrormodelPackage.getErrorModelPrototype(), null, "errorModelPrototype", null, 0, -1, FaultFailure_anomaly.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
