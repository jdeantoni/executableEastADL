/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events._instanceref.impl;
...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events._instanceref.EventFunctionClientServerPort_port;
...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events._instanceref._instancerefFactory;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events._instanceref._instancerefPackage;
...
public class _instancerefPackageImpl extends EPackageImpl implements _instancerefPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events._instanceref._instancerefPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getEventFunction_function_FunctionPrototype_context() {
		return (EReference)eventFunction_functionEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getEventFunction_function_FunctionPrototype_target() {
		return (EReference)eventFunction_functionEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getEventFunctionClientServerPort_port_FunctionPrototype() {
		return (EReference)eventFunctionClientServerPort_portEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getEventFunctionClientServerPort_port_FunctionClientServerPort() {
		return (EReference)eventFunctionClientServerPort_portEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getEventFunctionFlowPort_port_FunctionPrototype() {
		return (EReference)eventFunctionFlowPort_portEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getEventFunctionFlowPort_port_FunctionFlowPort() {
		return (EReference)eventFunctionFlowPort_portEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		eventFunction_functionEClass = createEClass(EVENT_FUNCTION_FUNCTION);
		createEReference(eventFunction_functionEClass, EVENT_FUNCTION_FUNCTION__FUNCTION_PROTOTYPE_CONTEXT);
		createEReference(eventFunction_functionEClass, EVENT_FUNCTION_FUNCTION__FUNCTION_PROTOTYPE_TARGET);

		eventFunctionClientServerPort_portEClass = createEClass(EVENT_FUNCTION_CLIENT_SERVER_PORT_PORT);
		createEReference(eventFunctionClientServerPort_portEClass, EVENT_FUNCTION_CLIENT_SERVER_PORT_PORT__FUNCTION_PROTOTYPE);
		createEReference(eventFunctionClientServerPort_portEClass, EVENT_FUNCTION_CLIENT_SERVER_PORT_PORT__FUNCTION_CLIENT_SERVER_PORT);

		eventFunctionFlowPort_portEClass = createEClass(EVENT_FUNCTION_FLOW_PORT_PORT);
		createEReference(eventFunctionFlowPort_portEClass, EVENT_FUNCTION_FLOW_PORT_PORT__FUNCTION_PROTOTYPE);
		createEReference(eventFunctionFlowPort_portEClass, EVENT_FUNCTION_FLOW_PORT_PORT__FUNCTION_FLOW_PORT);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(eventFunction_functionEClass, EventFunction_function.class, "EventFunction_function", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEventFunction_function_FunctionPrototype_context(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype_context", null, 0, -1, EventFunction_function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEventFunction_function_FunctionPrototype_target(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype_target", null, 1, 1, EventFunction_function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eventFunctionClientServerPort_portEClass, EventFunctionClientServerPort_port.class, "EventFunctionClientServerPort_port", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEventFunctionClientServerPort_port_FunctionPrototype(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype", null, 0, -1, EventFunctionClientServerPort_port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEventFunctionClientServerPort_port_FunctionClientServerPort(), theFunctionmodelingPackage.getFunctionClientServerPort(), null, "functionClientServerPort", null, 1, 1, EventFunctionClientServerPort_port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eventFunctionFlowPort_portEClass, EventFunctionFlowPort_port.class, "EventFunctionFlowPort_port", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEventFunctionFlowPort_port_FunctionPrototype(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype", null, 0, -1, EventFunctionFlowPort_port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEventFunctionFlowPort_port_FunctionFlowPort(), theFunctionmodelingPackage.getFunctionFlowPort(), null, "functionFlowPort", null, 1, 1, EventFunctionFlowPort_port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
