/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.impl;

import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.Eastadl21Package;

import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.AutosarFactory;
 ...
 * @generated
 */
public class AutosarPackageImpl extends EPackageImpl implements AutosarPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.AutosarPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AutosarPackageImpl() {
		super(eNS_URI, AutosarFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AutosarPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AutosarPackage init() {
		if (isInited) return (AutosarPackage)EPackage.Registry.INSTANCE.getEPackage(AutosarPackage.eNS_URI);

		// Obtain or create and register package
		AutosarPackageImpl theAutosarPackage = (AutosarPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AutosarPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AutosarPackageImpl());
		...
		theAutosarPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AutosarPackage.eNS_URI, theAutosarPackage);
		return theAutosarPackage;
	}
	...
	public AutosarFactory getAutosarFactory() {
		return (AutosarFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		GenericstructurePackage theGenericstructurePackage = (GenericstructurePackage)EPackage.Registry.INSTANCE.getEPackage(GenericstructurePackage.eNS_URI);
		SystemtemplatePackage theSystemtemplatePackage = (SystemtemplatePackage)EPackage.Registry.INSTANCE.getEPackage(SystemtemplatePackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theGenericstructurePackage);
		getESubpackages().add(theSystemtemplatePackage);
