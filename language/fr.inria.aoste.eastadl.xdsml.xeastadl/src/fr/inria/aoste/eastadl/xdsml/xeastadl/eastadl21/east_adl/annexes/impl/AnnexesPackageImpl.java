/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.annexes.impl;
...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.annexes.AnnexesFactory;
 ...
 * @generated
 */
public class AnnexesPackageImpl extends EPackageImpl implements AnnexesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.annexes.AnnexesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AnnexesPackageImpl() {
		super(eNS_URI, AnnexesFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AnnexesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AnnexesPackage init() {
		if (isInited) return (AnnexesPackage)EPackage.Registry.INSTANCE.getEPackage(AnnexesPackage.eNS_URI);

		// Obtain or create and register package
		AnnexesPackageImpl theAnnexesPackage = (AnnexesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AnnexesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AnnexesPackageImpl());
		...
		theAnnexesPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AnnexesPackage.eNS_URI, theAnnexesPackage);
		return theAnnexesPackage;
	}
	...
	public AnnexesFactory getAnnexesFactory() {
		return (AnnexesFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		BehaviorconstraintsPackage theBehaviorconstraintsPackage = (BehaviorconstraintsPackage)EPackage.Registry.INSTANCE.getEPackage(BehaviorconstraintsPackage.eNS_URI);
		NeedsPackage theNeedsPackage = (NeedsPackage)EPackage.Registry.INSTANCE.getEPackage(NeedsPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(theBehaviorconstraintsPackage);
