/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.formulalanguage.impl;
...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.formulalanguage.FormulalanguageFactory;
 ...
 * @generated
 */
public class FormulalanguagePackageImpl extends EPackageImpl implements FormulalanguagePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.formulalanguage.FormulalanguagePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private FormulalanguagePackageImpl() {
		super(eNS_URI, FormulalanguageFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link FormulalanguagePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static FormulalanguagePackage init() {
		if (isInited) return (FormulalanguagePackage)EPackage.Registry.INSTANCE.getEPackage(FormulalanguagePackage.eNS_URI);

		// Obtain or create and register package
		FormulalanguagePackageImpl theFormulalanguagePackage = (FormulalanguagePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FormulalanguagePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FormulalanguagePackageImpl());
		...
		theFormulalanguagePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(FormulalanguagePackage.eNS_URI, theFormulalanguagePackage);
		return theFormulalanguagePackage;
	}
	...
	public FormulalanguageFactory getFormulalanguageFactory() {
		return (FormulalanguageFactory)getEFactoryInstance();
	}
