...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.safetyconstraints.SafetyconstraintsFactory;
...
public class SafetyconstraintsPackageImpl extends EPackageImpl implements SafetyconstraintsPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.safetyconstraints.SafetyconstraintsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EAttribute getQuantitativeSafetyConstraint_FailureRate() {
		return (EAttribute)quantitativeSafetyConstraintEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getQuantitativeSafetyConstraint_ConstrainedFaultFailure() {
		return (EReference)quantitativeSafetyConstraintEClass.getEStructuralFeatures().get(2);
	}
	...
	public void initializePackageContents() {
		...
		fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.safetyconstraints._instanceref._instancerefPackage the_instancerefPackage_6 = (fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.safetyconstraints._instanceref._instancerefPackage)EPackage.Registry.INSTANCE.getEPackage(fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.dependability.safetyconstraints._instanceref._instancerefPackage.eNS_URI);
		ElementsPackage theElementsPackage = (ElementsPackage)EPackage.Registry.INSTANCE.getEPackage(ElementsPackage.eNS_URI);
		DatatypesPackage theDatatypesPackage = (DatatypesPackage)EPackage.Registry.INSTANCE.getEPackage(DatatypesPackage.eNS_URI);
		PrimitivetypesPackage thePrimitivetypesPackage = (PrimitivetypesPackage)EPackage.Registry.INSTANCE.getEPackage(PrimitivetypesPackage.eNS_URI);

		// Add subpackages
		getESubpackages().add(the_instancerefPackage_6);
		...
		initEReference(getFaultFailure_Anomaly(), the_instancerefPackage_6.getFaultFailure_anomaly(), null, "anomaly", null, 0, 1, FaultFailure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFaultFailure_FaultFailureValue(), theDatatypesPackage.getEADatatypePrototype(), null, "faultFailureValue", null, 1, 1, FaultFailure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getQuantitativeSafetyConstraint_FailureRate(), thePrimitivetypesPackage.getFloat(), "failureRate", "0.0", 1, 1, QuantitativeSafetyConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getQuantitativeSafetyConstraint_RepairRate(), thePrimitivetypesPackage.getFloat(), "repairRate", "0.0", 1, 1, QuantitativeSafetyConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSafetyConstraint_AsilValue(), this.getASILKind(), "asilValue", "ASIL_A", 1, 1, SafetyConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createTaggedValuesAnnotations() {
		...
		addAnnotation
		  (asilKindEEnum.getELiterals().get(0), 
		   source, 
		   new String[] {
			 "xml.name", "ASIL-A",
			 "xml.namePlural", "ASIL-AS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (asilKindEEnum.getELiterals().get(1), 
		   source, 
		   new String[] {
			 "xml.name", "ASIL-B",
			 "xml.namePlural", "ASIL-BS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (asilKindEEnum.getELiterals().get(2), 
		   source, 
		   new String[] {
			 "xml.name", "ASIL-C",
			 "xml.namePlural", "ASIL-CS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (asilKindEEnum.getELiterals().get(3), 
		   source, 
		   new String[] {
			 "xml.name", "ASIL-D",
			 "xml.namePlural", "ASIL-DS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (asilKindEEnum.getELiterals().get(4), 
		   source, 
		   new String[] {
			 "xml.name", "QM",
			 "xml.namePlural", "QMS",
