...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.requirements._instanceref.Satisfy_satisfiedBy;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.requirements._instanceref._instancerefFactory;
...
public class _instancerefPackageImpl extends EPackageImpl implements _instancerefPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.requirements._instanceref._instancerefPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getRefine_refinedBy_Identifiable_context() {
		return (EReference)refine_refinedByEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getRefine_refinedBy_Identifiable_target() {
		return (EReference)refine_refinedByEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getSatisfy_satisfiedBy_Identifiable_target() {
		return (EReference)satisfy_satisfiedByEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getSatisfy_satisfiedBy_Identifiable_context() {
		return (EReference)satisfy_satisfiedByEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		refine_refinedByEClass = createEClass(REFINE_REFINED_BY);
		createEReference(refine_refinedByEClass, REFINE_REFINED_BY__IDENTIFIABLE_CONTEXT);
		createEReference(refine_refinedByEClass, REFINE_REFINED_BY__IDENTIFIABLE_TARGET);

		satisfy_satisfiedByEClass = createEClass(SATISFY_SATISFIED_BY);
		createEReference(satisfy_satisfiedByEClass, SATISFY_SATISFIED_BY__IDENTIFIABLE_TARGET);
		createEReference(satisfy_satisfiedByEClass, SATISFY_SATISFIED_BY__IDENTIFIABLE_CONTEXT);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(refine_refinedByEClass, Refine_refinedBy.class, "Refine_refinedBy", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRefine_refinedBy_Identifiable_context(), theIdentifiablePackage.getIdentifiable(), null, "identifiable_context", null, 0, -1, Refine_refinedBy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRefine_refinedBy_Identifiable_target(), theIdentifiablePackage.getIdentifiable(), null, "identifiable_target", null, 1, 1, Refine_refinedBy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(satisfy_satisfiedByEClass, Satisfy_satisfiedBy.class, "Satisfy_satisfiedBy", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSatisfy_satisfiedBy_Identifiable_target(), theIdentifiablePackage.getIdentifiable(), null, "identifiable_target", null, 1, 1, Satisfy_satisfiedBy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSatisfy_satisfiedBy_Identifiable_context(), theIdentifiablePackage.getIdentifiable(), null, "identifiable_context", null, 0, -1, Satisfy_satisfiedBy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
