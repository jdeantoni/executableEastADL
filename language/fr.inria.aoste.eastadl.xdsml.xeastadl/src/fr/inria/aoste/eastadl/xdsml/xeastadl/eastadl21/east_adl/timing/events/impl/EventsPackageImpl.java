/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events.impl;
...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events.EventFunction;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events.EventFunctionClientServerPort;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events.EventFunctionClientServerPortKind;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events.EventFunctionFlowPort;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events.EventsFactory;
...
public class EventsPackageImpl extends EPackageImpl implements EventsPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events.EventsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events._instanceref._instancerefPackage the_instancerefPackage_5 = (fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events._instanceref._instancerefPackage)EPackage.Registry.INSTANCE.getEPackage(fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing.events._instanceref._instancerefPackage.eNS_URI);
		...
		// Add subpackages
		getESubpackages().add(the_instancerefPackage_5);
		...
		initEReference(getEventFunction_Function(), the_instancerefPackage_5.getEventFunction_function(), null, "function", null, 1, 1, EventFunction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEventFunctionClientServerPort_EventKind(), this.getEventFunctionClientServerPortKind(), "eventKind", "RECEIVEDREQUEST", 1, 1, EventFunctionClientServerPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEventFunctionClientServerPort_Port(), the_instancerefPackage_5.getEventFunctionClientServerPort_port(), null, "port", null, 1, 1, EventFunctionClientServerPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEventFunctionFlowPort_Port(), the_instancerefPackage_5.getEventFunctionFlowPort_port(), null, "port", null, 1, 1, EventFunctionFlowPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createTaggedValuesAnnotations() {
		...
		addAnnotation
		  (eventFunctionClientServerPortKindEEnum.getELiterals().get(0), 
		   source, 
		   new String[] {
			 "xml.name", "RECEIVED-REQUEST",
			 "xml.namePlural", "RECEIVED-REQUESTS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (eventFunctionClientServerPortKindEEnum.getELiterals().get(1), 
		   source, 
		   new String[] {
			 "xml.name", "SENT-RESPONSE",
			 "xml.namePlural", "SENT-RESPONSES",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (eventFunctionClientServerPortKindEEnum.getELiterals().get(2), 
		   source, 
		   new String[] {
			 "xml.name", "SENT-REQUEST",
			 "xml.namePlural", "SENT-REQUESTS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (eventFunctionClientServerPortKindEEnum.getELiterals().get(3), 
		   source, 
		   new String[] {
			 "xml.name", "RECEIVED-RESPONSE",
			 "xml.namePlural", "RECEIVED-RESPONSES",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });
	}
