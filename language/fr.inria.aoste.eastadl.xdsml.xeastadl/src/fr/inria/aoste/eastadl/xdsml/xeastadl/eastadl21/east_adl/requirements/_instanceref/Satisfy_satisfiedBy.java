 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.requirements._instanceref.Satisfy_satisfiedBy#getIdentifiable_target <em>Identifiable target</em>}</li>
 *   <li>{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.requirements._instanceref.Satisfy_satisfiedBy#getIdentifiable_context <em>Identifiable context</em>}</li>
 * </ul>
 *
 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.requirements._instanceref._instancerefPackage#getSatisfy_satisfiedBy()
 * @model
 * @generated
 */
public interface Satisfy_satisfiedBy extends EObject {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.requirements._instanceref._instancerefPackage#getSatisfy_satisfiedBy_Identifiable_target()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.requirements._instanceref.Satisfy_satisfiedBy#getIdentifiable_target <em>Identifiable target</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.requirements._instanceref._instancerefPackage#getSatisfy_satisfiedBy_Identifiable_context()
	 * @model
	 * @generated
	 */
