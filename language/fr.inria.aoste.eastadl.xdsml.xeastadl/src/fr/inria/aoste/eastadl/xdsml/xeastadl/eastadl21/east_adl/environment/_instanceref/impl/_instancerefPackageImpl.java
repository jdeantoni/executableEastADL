/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.environment._instanceref.impl;
...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.environment._instanceref.ClampConnector_port;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.environment._instanceref._instancerefFactory;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.environment._instanceref._instancerefPackage;
...
public class _instancerefPackageImpl extends EPackageImpl implements _instancerefPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.environment._instanceref._instancerefPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getClampConnector_port_FunctionPrototype() {
		return (EReference)clampConnector_portEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getClampConnector_port_FunctionPort() {
		return (EReference)clampConnector_portEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		clampConnector_portEClass = createEClass(CLAMP_CONNECTOR_PORT);
		createEReference(clampConnector_portEClass, CLAMP_CONNECTOR_PORT__FUNCTION_PROTOTYPE);
		createEReference(clampConnector_portEClass, CLAMP_CONNECTOR_PORT__FUNCTION_PORT);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(clampConnector_portEClass, ClampConnector_port.class, "ClampConnector_port", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getClampConnector_port_FunctionPrototype(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype", null, 0, -1, ClampConnector_port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClampConnector_port_FunctionPort(), theFunctionmodelingPackage.getFunctionPort(), null, "functionPort", null, 1, 1, ClampConnector_port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
