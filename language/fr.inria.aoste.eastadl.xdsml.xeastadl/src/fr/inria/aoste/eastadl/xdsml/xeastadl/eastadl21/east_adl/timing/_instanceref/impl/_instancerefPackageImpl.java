...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing._instanceref.PrecedenceConstraint_successive;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing._instanceref._instancerefFactory;
...
public class _instancerefPackageImpl extends EPackageImpl implements _instancerefPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.timing._instanceref._instancerefPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public EReference getPrecedenceConstraint_preceding_FunctionPrototype_target() {
		return (EReference)precedenceConstraint_precedingEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getPrecedenceConstraint_preceding_FunctionPrototype_context() {
		return (EReference)precedenceConstraint_precedingEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getPrecedenceConstraint_successive_FunctionPrototype_context() {
		return (EReference)precedenceConstraint_successiveEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getPrecedenceConstraint_successive_FunctionPrototype_target() {
		return (EReference)precedenceConstraint_successiveEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		precedenceConstraint_precedingEClass = createEClass(PRECEDENCE_CONSTRAINT_PRECEDING);
		createEReference(precedenceConstraint_precedingEClass, PRECEDENCE_CONSTRAINT_PRECEDING__FUNCTION_PROTOTYPE_TARGET);
		createEReference(precedenceConstraint_precedingEClass, PRECEDENCE_CONSTRAINT_PRECEDING__FUNCTION_PROTOTYPE_CONTEXT);

		precedenceConstraint_successiveEClass = createEClass(PRECEDENCE_CONSTRAINT_SUCCESSIVE);
		createEReference(precedenceConstraint_successiveEClass, PRECEDENCE_CONSTRAINT_SUCCESSIVE__FUNCTION_PROTOTYPE_CONTEXT);
		createEReference(precedenceConstraint_successiveEClass, PRECEDENCE_CONSTRAINT_SUCCESSIVE__FUNCTION_PROTOTYPE_TARGET);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(precedenceConstraint_precedingEClass, PrecedenceConstraint_preceding.class, "PrecedenceConstraint_preceding", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPrecedenceConstraint_preceding_FunctionPrototype_target(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype_target", null, 1, 1, PrecedenceConstraint_preceding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceConstraint_preceding_FunctionPrototype_context(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype_context", null, 0, -1, PrecedenceConstraint_preceding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(precedenceConstraint_successiveEClass, PrecedenceConstraint_successive.class, "PrecedenceConstraint_successive", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPrecedenceConstraint_successive_FunctionPrototype_context(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype_context", null, 0, -1, PrecedenceConstraint_successive.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPrecedenceConstraint_successive_FunctionPrototype_target(), theFunctionmodelingPackage.getFunctionPrototype(), null, "functionPrototype_target", null, 1, 1, PrecedenceConstraint_successive.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
