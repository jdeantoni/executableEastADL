...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.genericconstraints.GenericConstraintKind;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.genericconstraints.GenericConstraintSet;
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.genericconstraints.GenericconstraintsFactory;
...
public class GenericconstraintsPackageImpl extends EPackageImpl implements GenericconstraintsPackage {
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.east_adl.genericconstraints.GenericconstraintsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getGenericConstraint_GenericConstraintType() {
	...
	public EAttribute getGenericConstraint_GenericConstraintValue() {
		return (EAttribute)genericConstraintEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getTakeRateConstraint_TakeRate() {
		return (EAttribute)takeRateConstraintEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getTakeRateConstraint_Source() {
		return (EReference)takeRateConstraintEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(genericConstraintEClass, GENERIC_CONSTRAINT__GENERIC_CONSTRAINT_TYPE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGenericConstraint_GenericConstraintType(), this.getGenericConstraintKind(), "genericConstraintType", "SPACEREDUNDANCY", 1, 1, GenericConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGenericConstraint_GenericConstraintValue(), thePrimitivetypesPackage.getString(), "genericConstraintValue", "", 1, 1, GenericConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGenericConstraint_Target(), theIdentifiablePackage.getIdentifiable(), null, "target", null, 0, -1, GenericConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTakeRateConstraint_TakeRate(), thePrimitivetypesPackage.getFloat(), "takeRate", "0.0", 1, 1, TakeRateConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTakeRateConstraint_Source(), theIdentifiablePackage.getIdentifiable(), null, "source", null, 0, -1, TakeRateConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createTaggedValuesAnnotations() {
		...
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(0), 
		   source, 
		   new String[] {
			 "xml.name", "SPACE-REDUNDANCY",
			 "xml.namePlural", "SPACE-REDUNDANCYS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(1), 
		   source, 
		   new String[] {
			 "xml.name", "CABLE-LENGTH",
			 "xml.namePlural", "CABLE-LENGTHS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(2), 
		   source, 
		   new String[] {
			 "xml.name", "DEVELOPMENT-COST",
			 "xml.namePlural", "DEVELOPMENT-COSTS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(3), 
		   source, 
		   new String[] {
			 "xml.name", "POWER-CONSUMPTION",
			 "xml.namePlural", "POWER-CONSUMPTIONS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(4), 
		   source, 
		   new String[] {
			 "xml.name", "PIECE-COST",
			 "xml.namePlural", "PIECE-COSTS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(5), 
		   source, 
		   new String[] {
			 "xml.name", "STANDARD",
			 "xml.namePlural", "STANDARDS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(6), 
		   source, 
		   new String[] {
			 "xml.name", "WEIGHT",
			 "xml.namePlural", "WEIGHTS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(7), 
		   source, 
		   new String[] {
			 "xml.name", "OTHER",
		...
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(8), 
		   source, 
		   new String[] {
			 "xml.name", "FUNCTION-ALLOCATION-SAME-NODE",
			 "xml.namePlural", "FUNCTION-ALLOCATION-SAME-NODES",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(9), 
		   source, 
		   new String[] {
			 "xml.name", "FUNCTION-ALLOCATION-DIFFERENT-NODES",
			 "xml.namePlural", "FUNCTION-ALLOCATION-DIFFERENT-NODESS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(10), 
		   source, 
		   new String[] {
			 "xml.name", "POWER-SUPPLY-INDEPENDENT",
			 "xml.namePlural", "POWER-SUPPLY-INDEPENDENTS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });	
		addAnnotation
		  (genericConstraintKindEEnum.getELiterals().get(11), 
		   source, 
		   new String[] {
			 "xml.name", "TIME-REDUNDANCY",
			 "xml.namePlural", "TIME-REDUNDANCYS",
			 "xml.nsPrefix", "EA",
			 "xml.nsUri", "http://east-adl.info/2.1.10"
		   });
	}
