...
public class SystemtemplateSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SystemtemplatePackage.SYSTEM: {
				fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System system = (fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System)theEObject;
	 ...
	 * @generated
	 */
	public T caseSystem(fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.systemtemplate.System object) {
		return null;
	}
