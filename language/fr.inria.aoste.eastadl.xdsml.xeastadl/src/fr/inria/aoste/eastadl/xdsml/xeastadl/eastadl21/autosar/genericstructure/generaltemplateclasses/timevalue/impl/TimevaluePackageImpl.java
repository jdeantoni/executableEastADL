...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.generaltemplateclasses.timevalue.TimevalueFactory;
 ...
 * @generated
 */
public class TimevaluePackageImpl extends EPackageImpl implements TimevaluePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EDataType cseCodeTypeEDataType = null;
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.generaltemplateclasses.timevalue.TimevaluePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TimevaluePackageImpl() {
		super(eNS_URI, TimevalueFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link TimevaluePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TimevaluePackage init() {
		if (isInited) return (TimevaluePackage)EPackage.Registry.INSTANCE.getEPackage(TimevaluePackage.eNS_URI);

		// Obtain or create and register package
		TimevaluePackageImpl theTimevaluePackage = (TimevaluePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TimevaluePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TimevaluePackageImpl());
		...
		theTimevaluePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TimevaluePackage.eNS_URI, theTimevaluePackage);
		return theTimevaluePackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTimeValue_CseCode() {
	 ...
	 * @generated
	 */
	public EAttribute getTimeValue_CseCodeFactor() {
	 ...
	 * @generated
	 */
	public EDataType getCseCodeType() {
		return cseCodeTypeEDataType;
	}
	...
	public TimevalueFactory getTimevalueFactory() {
		return (TimevalueFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(timeValueEClass, TIME_VALUE__CSE_CODE);
		createEAttribute(timeValueEClass, TIME_VALUE__CSE_CODE_FACTOR);

		// Create data types
		cseCodeTypeEDataType = createEDataType(CSE_CODE_TYPE);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTimeValue_CseCode(), this.getCseCodeType(), "cseCode", "0", 1, 1, TimeValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeValue_CseCodeFactor(), thePrimitivetypesPackage.getInteger(), "cseCodeFactor", "0", 1, 1, TimeValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize data types
		initEDataType(cseCodeTypeEDataType, Integer.class, "CseCodeType", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}

} //TimevaluePackageImpl
