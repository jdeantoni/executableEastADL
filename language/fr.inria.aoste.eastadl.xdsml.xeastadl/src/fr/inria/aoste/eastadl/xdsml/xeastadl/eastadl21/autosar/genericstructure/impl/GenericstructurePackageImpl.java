/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.impl;
...
import fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.GenericstructureFactory;
 ...
 * @generated
 */
public class GenericstructurePackageImpl extends EPackageImpl implements GenericstructurePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EDataType trickEMFEDataType = null;
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.GenericstructurePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GenericstructurePackageImpl() {
		super(eNS_URI, GenericstructureFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GenericstructurePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GenericstructurePackage init() {
		if (isInited) return (GenericstructurePackage)EPackage.Registry.INSTANCE.getEPackage(GenericstructurePackage.eNS_URI);

		// Obtain or create and register package
		GenericstructurePackageImpl theGenericstructurePackage = (GenericstructurePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GenericstructurePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GenericstructurePackageImpl());
		...
		theGenericstructurePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GenericstructurePackage.eNS_URI, theGenericstructurePackage);
		return theGenericstructurePackage;
	}
	 ...
	 * @generated
	 */
	public EDataType gettrickEMF() {
		return trickEMFEDataType;
	}
	...
	public GenericstructureFactory getGenericstructureFactory() {
		return (GenericstructureFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		// Create data types
		trickEMFEDataType = createEDataType(TRICK_EMF);
	}
	...
	public void initializePackageContents() {
		...
		GeneraltemplateclassesPackage theGeneraltemplateclassesPackage = (GeneraltemplateclassesPackage)EPackage.Registry.INSTANCE.getEPackage(GeneraltemplateclassesPackage.eNS_URI);
		...
		// Add subpackages
		getESubpackages().add(theAutosartoplevelstructurePackage);
		getESubpackages().add(theGeneraltemplateclassesPackage);
		getESubpackages().add(theFormulalanguagePackage);
		getESubpackages().add(theAbstractstructurePackage);

		// Initialize data types
		initEDataType(trickEMFEDataType, Object.class, "trickEMF", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
	}

} //GenericstructurePackageImpl
