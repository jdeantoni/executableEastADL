...
import fr.inria.aoste.eastadl.xdsml.xeastadl.geastadl.ginfrastructure.GinfrastructureFactory;
...
import fr.inria.aoste.eastadl.xdsml.xeastadl.geastadl.ginfrastructure.trickEMFgenerator;
 ...
 * @generated
 */
public class GinfrastructurePackageImpl extends EPackageImpl implements GinfrastructurePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass trickEMFgeneratorEClass = null;
	 ...
	 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.geastadl.ginfrastructure.GinfrastructurePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GinfrastructurePackageImpl() {
		super(eNS_URI, GinfrastructureFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GinfrastructurePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GinfrastructurePackage init() {
		if (isInited) return (GinfrastructurePackage)EPackage.Registry.INSTANCE.getEPackage(GinfrastructurePackage.eNS_URI);

		// Obtain or create and register package
		GinfrastructurePackageImpl theGinfrastructurePackage = (GinfrastructurePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GinfrastructurePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GinfrastructurePackageImpl());
		...
		theGinfrastructurePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GinfrastructurePackage.eNS_URI, theGinfrastructurePackage);
		return theGinfrastructurePackage;
	}
	 ...
	 * @generated
	 */
	public EClass gettrickEMFgenerator() {
		return trickEMFgeneratorEClass;
	}
	...
	public GinfrastructureFactory getGinfrastructureFactory() {
		return (GinfrastructureFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		trickEMFgeneratorEClass = createEClass(TRICK_EM_FGENERATOR);
	}
	...
	public void initializePackageContents() {
		...
		// Add subpackages
		getESubpackages().add(theGelementsPackage);
		getESubpackages().add(theGprimitivetypesPackage);
		...
		initEClass(trickEMFgeneratorEClass, trickEMFgenerator.class, "trickEMFgenerator", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		// Create resource
		createResource(eNS_URI);
	}

} //GinfrastructurePackageImpl
