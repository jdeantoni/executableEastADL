/**
 */
package fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.autosartoplevelstructure.util;
 ...
 * <!-- end-user-doc -->
 * @see fr.inria.aoste.eastadl.xdsml.xeastadl.eastadl21.autosar.genericstructure.autosartoplevelstructure.AutosartoplevelstructurePackage
 * @generated
 */
public class AutosartoplevelstructureSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public AutosartoplevelstructureSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AutosartoplevelstructurePackage.PACKAGEABLE_ELEMENT: {
				PackageableElement packageableElement = (PackageableElement)theEObject;
				T result = casePackageableElement(packageableElement);
				if (result == null) result = caseIdentifiable(packageableElement);
				if (result == null) result = caseReferrable(packageableElement);
				if (result == null) result = caseGIdentifiable(packageableElement);
				if (result == null) result = caseGReferrable(packageableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AutosartoplevelstructurePackage.AUTOSAR: {
				AUTOSAR autosar = (AUTOSAR)theEObject;
				T result = caseAUTOSAR(autosar);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AutosartoplevelstructurePackage.AR_ELEMENT: {
				ARElement arElement = (ARElement)theEObject;
				T result = caseARElement(arElement);
				if (result == null) result = casePackageableElement(arElement);
				if (result == null) result = caseIdentifiable(arElement);
				if (result == null) result = caseReferrable(arElement);
				if (result == null) result = caseGIdentifiable(arElement);
				if (result == null) result = caseGReferrable(arElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
...
} //AutosartoplevelstructureSwitch
