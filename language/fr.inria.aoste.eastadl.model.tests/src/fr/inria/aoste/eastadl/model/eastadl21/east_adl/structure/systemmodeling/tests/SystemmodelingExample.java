...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>systemmodeling</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemmodelingExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.systemmodeling"));
				VehicleLevel root = SystemmodelingFactory.eINSTANCE.createVehicleLevel();
