...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Logical Bus</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class LogicalBusTest extends AllocationTargetTest {
	...
	public static void main(String[] args) {
		TestRunner.run(LogicalBusTest.class);
	}
	 ...
	 * @generated
	 */
	public LogicalBusTest(String name) {
		super(name);
	}
	 ...
	 */
	@Override
	protected LogicalBus getFixture() {
		return (LogicalBus)fixture;
	}
	...
	protected void setUp() throws Exception {
		setFixture(HardwaremodelingFactory.eINSTANCE.createLogicalBus());
	}
