...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>timevalue</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TimevalueExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(TimevaluePackage.eNS_URI, 
			 TimevaluePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.timevalue"));
				TimeValue root = TimevalueFactory.eINSTANCE.createTimeValue();
