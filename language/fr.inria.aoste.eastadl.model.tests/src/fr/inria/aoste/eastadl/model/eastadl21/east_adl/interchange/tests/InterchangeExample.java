...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>interchange</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class InterchangeExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.interchange"));
				RIFExportArea root = InterchangeFactory.eINSTANCE.createRIFExportArea();
