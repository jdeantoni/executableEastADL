...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>needs</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class NeedsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.needs"));
				ArchitecturalDescription root = NeedsFactory.eINSTANCE.createArchitecturalDescription();
