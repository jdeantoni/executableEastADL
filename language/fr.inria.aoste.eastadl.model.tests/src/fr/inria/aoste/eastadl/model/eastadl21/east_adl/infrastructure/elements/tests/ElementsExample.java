...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>elements</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.elements"));
				Comment root = ElementsFactory.eINSTANCE.createComment();
