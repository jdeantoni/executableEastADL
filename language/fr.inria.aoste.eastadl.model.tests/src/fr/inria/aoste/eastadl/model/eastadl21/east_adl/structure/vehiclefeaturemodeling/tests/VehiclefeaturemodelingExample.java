...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>vehiclefeaturemodeling</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class VehiclefeaturemodelingExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(VehiclefeaturemodelingPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.vehiclefeaturemodeling"));
				DeviationAttributeSet root = VehiclefeaturemodelingFactory.eINSTANCE.createDeviationAttributeSet();
