...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>errormodel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrormodelExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.errormodel"));
				ErrorBehavior root = ErrormodelFactory.eINSTANCE.createErrorBehavior();
