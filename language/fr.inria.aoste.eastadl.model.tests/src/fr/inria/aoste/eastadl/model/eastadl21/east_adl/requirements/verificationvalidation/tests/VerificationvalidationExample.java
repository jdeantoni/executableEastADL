...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>verificationvalidation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class VerificationvalidationExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(VerificationvalidationPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.verificationvalidation"));
				VerificationValidation root = VerificationvalidationFactory.eINSTANCE.createVerificationValidation();
