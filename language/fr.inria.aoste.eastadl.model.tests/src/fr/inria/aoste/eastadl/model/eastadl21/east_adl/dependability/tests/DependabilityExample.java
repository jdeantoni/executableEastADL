 ...
 * @generated
 */
public class DependabilityExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.dependability"));
				Dependability root = DependabilityFactory.eINSTANCE.createDependability();
