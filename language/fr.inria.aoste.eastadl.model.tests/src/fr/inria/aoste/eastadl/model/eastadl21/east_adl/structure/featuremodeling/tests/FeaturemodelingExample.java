...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>featuremodeling</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FeaturemodelingExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(FeaturemodelingPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.featuremodeling"));
				BindingTime root = FeaturemodelingFactory.eINSTANCE.createBindingTime();
