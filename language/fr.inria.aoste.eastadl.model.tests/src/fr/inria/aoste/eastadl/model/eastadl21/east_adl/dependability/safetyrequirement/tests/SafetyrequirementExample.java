...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>safetyrequirement</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SafetyrequirementExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(SafetyrequirementPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.safetyrequirement"));
				FunctionalSafetyConcept root = SafetyrequirementFactory.eINSTANCE.createFunctionalSafetyConcept();
