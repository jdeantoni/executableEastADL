...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>functionmodeling</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionmodelingExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(FunctionmodelingPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.functionmodeling"));
				Allocation root = FunctionmodelingFactory.eINSTANCE.createAllocation();
