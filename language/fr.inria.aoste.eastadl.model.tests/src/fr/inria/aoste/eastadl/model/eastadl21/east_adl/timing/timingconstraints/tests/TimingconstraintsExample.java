...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>timingconstraints</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TimingconstraintsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(TimingconstraintsPackage.eNS_URI, 
			 TimingconstraintsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.timingconstraints"));
				ArbitraryEventConstraint root = TimingconstraintsFactory.eINSTANCE.createArbitraryEventConstraint();
