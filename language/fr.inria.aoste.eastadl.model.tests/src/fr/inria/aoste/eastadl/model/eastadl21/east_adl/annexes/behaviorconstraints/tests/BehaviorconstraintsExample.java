...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>behaviorconstraints</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class BehaviorconstraintsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(BehaviorconstraintsPackage.eNS_URI, 
			 BehaviorconstraintsPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.behaviorconstraints"));
				BehaviorAnnex root = BehaviorconstraintsFactory.eINSTANCE.createBehaviorAnnex();
