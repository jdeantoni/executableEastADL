...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>safetycase</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SafetycaseExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.safetycase"));
				Claim root = SafetycaseFactory.eINSTANCE.createClaim();
