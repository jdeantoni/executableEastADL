...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>timing</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TimingExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.timing"));
				EventChain root = TimingFactory.eINSTANCE.createEventChain();
