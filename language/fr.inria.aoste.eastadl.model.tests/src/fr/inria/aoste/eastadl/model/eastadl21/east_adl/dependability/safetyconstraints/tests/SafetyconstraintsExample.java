...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>safetyconstraints</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class SafetyconstraintsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(SafetyconstraintsPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.safetyconstraints"));
				FaultFailure root = SafetyconstraintsFactory.eINSTANCE.createFaultFailure();
