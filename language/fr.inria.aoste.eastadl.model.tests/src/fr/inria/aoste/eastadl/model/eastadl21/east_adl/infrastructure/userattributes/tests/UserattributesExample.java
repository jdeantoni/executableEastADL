...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>userattributes</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class UserattributesExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.userattributes"));
				UserAttributeableElement root = UserattributesFactory.eINSTANCE.createUserAttributeableElement();
