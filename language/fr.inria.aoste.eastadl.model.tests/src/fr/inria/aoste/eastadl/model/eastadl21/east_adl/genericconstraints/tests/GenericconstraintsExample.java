...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>genericconstraints</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class GenericconstraintsExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(GenericconstraintsPackage.eNS_URI, 
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.genericconstraints"));
				GenericConstraint root = GenericconstraintsFactory.eINSTANCE.createGenericConstraint();
